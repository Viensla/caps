...
},l.Vehicle.prototype.addWheel=function(a,b,c,d,e,f,g,h,i){var j=new THREE.Mesh(a,b);j.castShadow=j.receiveShadow=!0,j.position.copy(d).multiplyScalar(f/100).add(c),this.world.add(j),this.wheels.push(j),this.world.execute("addWheel",{id:this._physijs.id,connection_point:{x:c.x,y:c.y,z:c.z},wheel_direction:{x:d.x,y:d.y,z:d.z},wheel_axle:{x:e.x,y:e.y,z:e.z},suspension_rest_length:f,wheel_radius:g,is_front_wheel:h,tuning:i})},l.Vehicle.prototype.setSteering=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("setSteering",{id:this._physijs.id,wheel:b,steering:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("setSteering",{id:this._physijs.id,wheel:c,steering:a})},l.Vehicle.prototype.setBrake=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("setBrake",{id:this._physijs.id,wheel:b,brake:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("setBrake",{id:this._physijs.id,wheel:c,brake:a})},l.Vehicle.prototype.applyEngineForce=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("applyEngineForce",{id:this._physijs.id,wheel:b,force:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("applyEngineForce",{id:this._physijs.id,wheel:c,force:a})},l.VehicleTuning=function(a,b,c,d,e,f){this.suspension_stiffness=void 0!==a?a:5.88,this.suspension_compression=void 0!==b?b:.83,this.suspension_damping=void 0!==c?c:.88,this.max_suspension_travel=void 0!==d?d:500,this.friction_slip=void 0!==e?e:10.5,this.max_suspension_force=void 0!==f?f:6e3},l}();var Interface;jQuery(function(a){function b(){pb.isPlaying&&((Wb.bottlecaps.position.y<=Wb.bottle.position.y||Wb.bottlecaps.position.y>Wb.bottle.position.y+35||Wb.bottlecaps.position.x>Wb.bottle.position.x+7||Wb.bottlecaps.position.x<Wb.bottle.position.x-7||Wb.bottlecaps.position.z>Wb.bottle.position.z+7||Wb.bottlecaps.position.z<Wb.bottle.position.z-7)&&!Wb.bottlecaps.capsed&&(Wb.bottlecaps.capsed=!0,Wb.bottlecaps.collided=!1,pb.plcaps()),(Ub.bottlecaps.position.y<=Ub.bottle.position.y||Ub.bottlecaps.position.y>Ub.bottle.position.y+35||Ub.bottlecaps.position.x>Ub.bottle.position.x+7||Ub.bottlecaps.position.x<Ub.bottle.position.x-7||Ub.bottlecaps.position.z>Ub.bottle.position.z+7||Ub.bottlecaps.position.z<Ub.bottle.position.z-7)&&!Ub.bottlecaps.capsed&&(Ub.bottlecaps.capsed=!0,Ub.bottlecaps.collided=!1,K.solo&&pb.vlcaps())),M&&Ub.isPlaying&&!Wb.isPlaying&&M.position.copy(O),Wb.cursor&&Wb.liveVector&&(Wb.cursor.__dirtyPosition=!1,Wb.cursor.position.copy(Wb.liveVector)),p.simulate(void 0,2),U.lookAt(V);var e=5e-4*Date.now();if(d(e),Math.sin(2*e)>.5&&zb.animeLight(),yb)var g=f(yb,U);TweenLite.set(a("#txto-rc"),{y:g.y,x:g.x}),c(e/10),q.render(p,U),requestAnimationFrame(b)}function c(a){for(var b=0;b<Rb.length;b++){var c=Rb[b];c instanceof THREE.PointCloud&&(c.rotation.y=a*(4>b?b+1:-(b+1)))}}function d(a){U.initialpos.x+=Math.sin(2*a)*Ub.drunked/70,U.initialpos.y+=Math.cos(2*a)*Ub.drunked/70,U.initialpos.z+=Math.sin(2*a)*Ub.drunked/70,U.position.x+=.3*(20*z.x-U.position.x)*3+U.initialpos.x,U.position.y+=1.5*(10*z.y-U.position.y)+U.initialpos.y+80}function e(){u=window.innerWidth,v=window.innerHeight,T>1?(q.setViewport(0,0,u/2,v/2),q.setSize(u/1.5,v/1.5),a(q.domElement).css({width:u,height:v})):(q.setSize(u,v),q.setViewport(0,0,u,v)),U.aspect=u/v,U.updateProjectionMatrix(),Interface.resize()}function f(a,b){var c=new THREE.Vector3,d=.5*u,e=.5*v;return a.updateMatrixWorld(),c.setFromMatrixPosition(a.matrixWorld),c.project(b),c.x=c.x*d+d,c.y=-(c.y*e)+e,{x:Math.round(c.x),y:Math.round(c.y)}}function g(){W=new THREE.PerspectiveCamera(X,Y,Z,$),W.initialpos=new THREE.Vector3(0,160,165),W.position.set(W.initialpos.x,W.initialpos.y,W.initialpos.z),W.lookAt(p),p.add(W),V=new THREE.Vector3(0,50,-100),U=W,z={x:0,y:0},document.addEventListener("mousemove",function(a){z.x=a.clientX/window.innerWidth-.5,z.y=a.clientY/window.innerHeight-.5,U.position.x+=.3*(20*z.x-U.position.x)*3+U.initialpos.x,U.position.y+=1.5*(10*z.y-U.position.y)+U.initialpos.y+80},!1)}function h(a){var b=2;"undefined"==typeof a&&(a="pl");var c;c="pl"==a?Ub.capmat.clone():Wb.capmat.clone(),c.side=2,r=new Physijs.CylinderMesh(Jb,c,b,{friction:1,restitution:.5}),r.stopGravity=function(){var a,b=this,c=0;setTimeout(function(){b.material.materials[0].transparent=!0,b.material.materials[1].transparent=!0,a=setInterval(function(){b.material.materials[0].opacity=c%2==0?0:1,b.material.materials[1].opacity=c%2==0?0:1,c++,10==c&&(clearInterval(a),b.material.materials[0].opacity=1,b.material.materials[1].opacity=1,p.remove(b))},200-c)},4e3)},r.scale.set(S,S,S),r.collisions=0,r.addEventListener("collision",capCollision);var d=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:r.material.materials[1].color,transparent:!0,opacity:1}),0);if(d.position.x=0,d.position.y=.3,d.position.z=0,r.add(d),r.position.y=50,r.position.x=0,r.position.z=Q*R,r.castShadow=!0,r.receiveShadow=!0,p.add(r),L.push(r),M=r,M.floating=!0,M.name="vl"==a?"viensla":"player",L.length>4){var e=L[0];e.stopGravity(),L.splice(0,1)}}function i(){var a;a=setInterval(function(){P&&(_+=bb,_>100&&(bb=-ab),0>_&&(bb=+ab),TweenMax.set(C.find(".bar"),{height:_+"%"}))},10+Wb.lives/10)}function j(b,c){"undefined"==typeof c&&(c=300);var d=400;if(b.attr("class","capsIn1"),setTimeout(function(){b.attr("class","capsIn2"),setTimeout(function(){b.attr("class","capsIn3"),setTimeout(function(){b.attr("class","")},d)},d+c)},d),b==J){Zb.playSd("perfect");var e=Math.ceil(10*Math.random());a("#perfect-b").removeClass().addClass("g"+e),a("#perfect-b").addClass("active"),setTimeout(function(){a("#perfect-b").removeClass("active"),setTimeout(function(){a("#perfect-b").removeClass()},1e3)},2500)}}function k(){rb=new Physijs.BoxMesh(new THREE.BoxGeometry(1,1,1),new THREE.MeshPhongMaterial({color:mb}),0),rb.position.x=0,rb.position.y=0,rb.position.z=0,rb.castShadow=!1,rb.receiveShadow=!1,rb.name="level",sb=new Physijs.BoxMesh(new THREE.CylinderGeometry(800,800,30,16),new THREE.MeshPhongMaterial({color:jb}),0),sb.position.x=0,sb.position.y=-1,sb.position.z=0,sb.castShadow=!1,sb.receiveShadow=!0,sb.name="floor",rb.add(sb);var a=THREE.Curve.create(function(a){this.scale=void 0===a?1:a},function(a){return new THREE.Vector3(0,a,0).multiplyScalar(this.scale)}),b=new a(200,100),c=new THREE.TubeGeometry(b,100,580,100,!0);xb=new THREE.Mesh(c,new THREE.MeshBasicMaterial({color:jb,shininess:100,side:THREE.BackSide})),xb.rotation.y=Math.PI/2,xb.position.x=0,xb.position.y=-90,xb.position.z=100,xb.castShadow=!0,xb.receiveShadow=!0,xb.name="bar",xb.rotation.x=-.06,rb.add(xb);var d=THREE.ImageUtils.loadTexture("images/v2/bar_single.png");d.minFilter=THREE.LinearFilter,wb=new Physijs.BoxMesh(new THREE.BoxGeometry(500,125,1),new THREE.MeshBasicMaterial({map:d,transparent:!0,opacity:1}),0),wb.position.x=3,wb.position.y=77,wb.position.z=-435,wb.castShadow=!0,wb.receiveShadow=!0,wb.rotation.x=-.06,rb.add(wb),d=THREE.ImageUtils.loadTexture("images/v2/bar-neon-orange.png"),d.minFilter=THREE.LinearFilter,wb=new Physijs.BoxMesh(new THREE.BoxGeometry(119,68,1),new THREE.MeshPhongMaterial({map:d,transparent:!0,opacity:.7}),0),wb.position.x=3,wb.position.y=180,wb.position.z=-600,wb.castShadow=!0,wb.receiveShadow=!0,rb.add(wb),d=THREE.ImageUtils.loadTexture("images/v2/armoires_back.png"),d.minFilter=THREE.LinearFilter,wb=new Physijs.BoxMesh(new THREE.BoxGeometry(1712,335,10),new THREE.MeshPhongMaterial({map:d,transparent:!0,opacity:.2}),0),wb.rotation.x=-.37,wb.position.x=0,wb.position.y=130,wb.position.z=-600,wb.castShadow=!0,wb.receiveShadow=!0,rb.add(wb),tb=new Physijs.BoxMesh(new THREE.BoxGeometry(w,x,35),new THREE.MeshPhongMaterial({color:hb}),0),tb.rotation.x=Math.PI/2,tb.position.x=0,tb.position.y=0,tb.position.z=0,tb.castShadow=!1,tb.receiveShadow=!1,tb.name="tapis";var e=new Physijs.BoxMesh(new THREE.CylinderGeometry(140,140,10,64),new THREE.MeshPhongMaterial({color:16777215,transparent:!0,opacity:.1}),0);e.rotation.x=Math.PI/2,e.position.y=-80,e.position.z=-10,tb.add(e);var f=new Physijs.BoxMesh(new THREE.CylinderGeometry(90,90,2,64),new THREE.MeshPhongMaterial({color:263172,transparent:!0,opacity:.05}),0);f.scale.set(1,1,.4),f.rotation.x=Math.PI/2,f.position.y=-130,f.position.z=-17,tb.add(f),p.add(tb);var g=new THREE.BoxGeometry(Qb[0],Qb[1]+10,Qb[2]);ub=new Physijs.BoxMesh(g,new THREE.MeshPhongMaterial({color:lb}),0);var h=new Physijs.BoxMesh(g,new THREE.MeshPhongMaterial({color:0}),0);h.position.z=-.5,h.scale.set(1.01,1.05,1.05),ub.castShadow=!0,ub.receiveShadow=!0,ub.rotation.x=.3,ub.position.x=0,ub.position.y=Qb[1]-6.3,ub.position.z=-110,rb.add(ub);var i=new THREE.BoxGeometry(Pb[0],Pb[1],Pb[2]);vb=new Physijs.BoxMesh(i,new THREE.MeshPhongMaterial({color:kb}),0);var j=new Physijs.BoxMesh(i,new THREE.MeshLambertMaterial({color:0}),0);j.position.z=-2,j.position.y=-.5,j.scale.set(1.01,1.05,1.1),vb.position.x=0,vb.position.y=Qb[1]+Qb[1]/2,vb.position.z=-110,vb.castShadow=!0,vb.receiveShadow=!0,rb.add(vb),vb=new Physijs.BoxMesh(new THREE.BoxGeometry(Pb[0]+100,Pb[1],Pb[2]),new THREE.MeshBasicMaterial({color:16171623}),0),j=new Physijs.BoxMesh(new THREE.BoxGeometry(Pb[0]+100,Pb[1],Pb[2]),new THREE.MeshPhongMaterial({color:0}),0),j.position.z=-.5,j.position.y=-.2,j.scale.set(1.01,1,1),vb.position.x=0,vb.position.y=Qb[1]+Qb[1]/2,vb.position.z=110,vb.castShadow=!0,vb.receiveShadow=!0,rb.add(vb),d=THREE.ImageUtils.loadTexture("images/phone/phone_veille.png"),d.minFilter=THREE.LinearFilter;var k=new THREE.MeshPhongMaterial({map:d}),l=new THREE.MeshPhongMaterial({color:16569893}),m=[l,l,k,l,l,l];yb=new Physijs.BoxMesh(new THREE.BoxGeometry(10,1,14),new THREE.MeshFaceMaterial(m),0),yb.position.x=50,yb.position.y=3,yb.position.z=-5,yb.rotation.y=.3,yb.castShadow=!0,yb.receiveShadow=!0,d=THREE.ImageUtils.loadTexture("images/phone/phone_message.png"),d.minFilter=THREE.LinearFilter;var n=new THREE.Mesh(new THREE.BoxGeometry(10,.1,14),new THREE.MeshBasicMaterial({opacity:0,transparent:!0,map:d}));d=THREE.ImageUtils.loadTexture("images/phone/phone_white.png"),d.minFilter=THREE.LinearFilter;var o=new THREE.Mesh(new THREE.BoxGeometry(10,.1,14),new THREE.MeshBasicMaterial({opacity:0,transparent:!0,map:d}));n.position.set(0,.5,0),o.position.set(0,.5,0),yb.add(n),yb.add(o),yb.receiveMessage=function(){Zb.playSd("vibreur");var a=0;n.material.opacity=1,yb.interval=setInterval(function(){n.material.opacity=a%2==0?0:1,o.material.opacity=a%2==0?1:0,a++,a>5&&clearInterval(yb.interval)},250)},yb.closeMessage=function(){clearInterval(yb.interval),n.material.opacity=0,o.material.opacity=0},vb.add(yb),p.add(rb);var q=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.02,side:2}),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q);r.scale.set(1,1,1),r.rotation.y=Math.PI/2;var s=new THREE.PointLight(16777215,.1,100);s.position.set(0,150,-80),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.9,.9,.9),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.8,.8,.8),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.7,.7,.7),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.6,.6,.6),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.5,.5,.5),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.4,.4,.4),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.3,.3,.3),s.add(r),p.add(s);var t=new THREE.HemisphereLight(ib,ib,.5);t.color.setHex(ib),t.groundColor.setHSL(.5,.5,.5),t.position.set(0,600,0);var u=document.getElementById("vertexShader").textContent,v=document.getElementById("fragmentShader").textContent,y={topColor:{type:"c",value:new THREE.Color(gb)},bottomColor:{type:"c",value:new THREE.Color(ib)},offset:{type:"f",value:10},exponent:{type:"f",value:.7}};y.topColor.value.copy(t.color);var z=new THREE.SphereGeometry(1600,4,5),A=new THREE.ShaderMaterial({vertexShader:u,fragmentShader:v,uniforms:y,side:THREE.BackSide}),B=new THREE.Mesh(z,A);p.add(B);var C=new THREE.ImageUtils.loadTexture("images/dust.png");C.minFilter=THREE.LinearFilter;for(var D,E=new THREE.Geometry,F=[5,4,3,2,1],G=0;200>G;G++){var H=new THREE.Vector3;H.x=120*Math.random()-60,H.y=120*Math.random()-60,H.z=120*Math.random()-60,E.vertices.push(H)}for(var G=0;G<F.length;G++){var I=new THREE.PointCloudMaterial({size:F[G],map:C,blending:THREE.AdditiveBlending,transparent:!0,opacity:.04});D=new THREE.PointCloud(E,I),D.rotation.x=6*Math.random(),D.rotation.y=6*Math.random(),D.rotation.z=6*Math.random(),D.position.y=120,D.position.z=-50,Rb.push(D),p.add(D)}}function l(){for(var a=[[-40,85,110],[-35,88,110],[-37,89,112],[-34,85,111],[40,85,-110],[35,88,-110],[34,85,-111]],b=0;7>b;b++)Sb.push(new Physijs.CylinderMesh(Jb,Bb.ptp,.4,{friction:1,restitution:.5})),Sb[b].scale.set(S,S,S),Sb[b].position.x=a[b][0],Sb[b].position.y=a[b][1],Sb[b].position.z=a[b][2],Sb[b].rotation.y=Math.PI/(b+1),p.add(Sb[b])}function m(){Ab=new THREE.HemisphereLight(16777215,16777215,.3),Ab.color.setHSL(.6,1,.6),Ab.groundColor.setHSL(.095,1,.75),Ab.position.set(0,500,0),p.add(Ab);var a=new THREE.DirectionalLight(16777215,.5);a.color.setHSL(.1,1,.95),a.position.set(0,1,0),a.position.multiplyScalar(50),p.add(a),a.castShadow=!0,a.shadowMapWidth=2048,a.shadowMapHeight=2048;var b=50;a.shadowCameraLeft=-b,a.shadowCameraRight=b,a.shadowCameraTop=b,a.shadowCameraBottom=-b,a.shadowCameraFar=3500,a.shadowBias=-1e-4,a.shadowDarkness=.35;var c=new THREE.SpotLight(16777215);c.position.set(0,160,-110),c.target.position.set(0,50,-110),c.target.updateMatrixWorld(),c.intensity=.3,p.add(c);var d=new THREE.SpotLight(16777215);d.position.set(0,300,0),d.target.position.set(0,0,0),d.target.updateMatrixWorld(),d.intensity=.5,p.add(d);var e=new THREE.SpotLight(16777215);e.position.set(0,0,120),e.target.position.set(0,20,-110),e.target.updateMatrixWorld(),e.intensity=1,p.add(e),zb=new THREE.PointLight(jb,2,100),zb.position.set(3,180,-580),zb.animeLight=function(){this.intensity=Math.random()>.9?.2:2},p.add(zb);var f=c.clone();f.position.set(0,200,120),f.target.position.set(0,50,120),f.target.updateMatrixWorld(),f.intensity=.7,p.add(f);var g=new THREE.SpotLight(16777215);g.position.set(0,300,-20),g.target.position.set(0,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,p.add(g),g=new THREE.SpotLight(16777215),g.position.set(500,300,-20),g.target.position.set(200,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,p.add(g),g=new THREE.SpotLight(16777215),g.position.set(-500,300,-20),g.target.position.set(-200,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,p.add(g);var h=new THREE.HemisphereLight(16777215,16777215,.4);h.color.setHex(15724527),h.groundColor.setHSL(.2,.2,.2),h.position.set(0,300,0),p.add(h);var i=new THREE.HemisphereLight(16777215,16777215,.4);i.color.setHex(15724527),i.position.set(0,300,-400),p.add(i)}function n(){var a=new THREE.JSONLoader;Cb={chimey:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/chimais.png"),side:2,transparent:!0,opacity:1}),foster:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/faustaire.png"),side:2,transparent:!0,opacity:1}),lef:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/lef.png"),side:2,transparent:!0,opacity:1}),pelle:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/pelle.png"),side:2,transparent:!0,opacity:1}),chouffe:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/shouffe.png"),side:2,transparent:!0,opacity:1}),ptp:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/ptp.png"),side:2,transparent:!0,opacity:1})},Cb.chimey.map.minFilter=THREE.LinearFilter,Cb.foster.map.minFilter=THREE.LinearFilter,Cb.lef.map.minFilter=THREE.LinearFilter,Cb.pelle.map.minFilter=THREE.LinearFilter,Cb.chouffe.map.minFilter=THREE.LinearFilter,Cb.ptp.map.minFilter=THREE.LinearFilter,a.load("model/3D/cap_light.json",function(b,c){a.load("model/3D/bottle_light.json",function(a,d){Kb=a;var e=d[0];e.side=2,e.shininess=0,e.shading=0,e.reflectivity=0,e.color.setHex(16777215),Lb=new THREE.MeshFaceMaterial(d),Jb=b;var f=[];f[0]=c[0].clone(),f[1]=c[0].clone(),f[0].side=2,f[1].side=2,f[1].map=0,Eb=new THREE.MeshFaceMaterial(f),Eb.materials[1].color=new THREE.Color(nb.chimey);var g=[];g[0]=c[1].clone(),g[1]=c[0].clone(),g[0].side=2,g[1].side=2,g[1].map=0,Db=new THREE.MeshFaceMaterial(g),Db.materials[1].color=new THREE.Color(nb.foster);var h=[];h[0]=c[2].clone(),h[1]=c[0].clone(),h[0].side=2,h[1].side=2,h[1].map=0,Gb=new THREE.MeshFaceMaterial(h),Gb.materials[1].color=new THREE.Color(nb.lef);var i=[];i[0]=c[3].clone(),i[1]=c[0].clone(),i[0].side=2,i[1].side=2,i[1].map=0,Fb=new THREE.MeshFaceMaterial(i),Fb.materials[1].color=new THREE.Color(nb.pelle);var j=[];j[0]=c[4].clone(),j[1]=c[0].clone(),j[0].side=2,j[1].side=2,j[1].map=0,Hb=new THREE.MeshFaceMaterial(j),Hb.materials[1].color=new THREE.Color(nb.chouffe);var k=[];k[0]=c[5].clone(),k[1]=c[2].clone(),k[0].side=2,k[1].side=2,k[1].map=0,Ib=new THREE.MeshFaceMaterial(k),Ib.materials[1].color=new THREE.Color(nb.ptp),Bb={chimey:Eb,foster:Db,lef:Gb,pelle:Fb,chouffe:Hb,ptp:Ib},t()})})}var o,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D,E,F,G,H,I,J,K={camera:null,solo:!1,quality:"high"},L=[],M=null,N=new THREE.Vector3,O=new THREE.Vector3(0,0,0),P=(new THREE.Clock,!1);Physijs.scripts.worker="/js/physics/physics_wkr.js",Physijs.scripts.ammo="ammo.js",u=window.innerWidth,v=window.innerHeight;var Q=100,R=1,S=1.6,T=window.devicePixelRatio||1;t=function(){o=document.getElementById("viewport"),p=new Physijs.Scene,p.setGravity(new THREE.Vector3(0,-80,0)),q=new THREE.WebGLRenderer({antialias:!0,alpha:!0,precision:"lowp",devicePixelRatio:T}),q.setPixelRatio(T),T>1?(q.setViewport(0,0,u/2,v/2),q.setSize(u/1.5,v/1.5),a(q.domElement).css({width:u,height:v})):(q.setSize(u,v),q.setViewport(0,0,u,v)),q.shadowMapEnabled=!1,q.shadowMapSoft=!1,q.shadowMapType=THREE.PCFShadowMap,q.shadowMapAutoUpdate=!1,q.gammaInput=!0,q.gammaOutput=!0,o.appendChild(q.domElement),g(),m(),k(),Wb.initialize(),Ub.initialize(),y=Wb.bottle,p.simulate(),s(),l(),Nb.addClass(Mb.Player.caps),a("#versus-bar .pl").addClass(Mb.Player.caps),Ub.capmat=Bb[Mb.Player.caps].clone(),Ub.stickermat=Cb[Mb.Player.caps].clone(),Ub.bottle.material.color=Ub.capmat.materials[1].color,Ub.changeSticker(),Wb.changeBottle(Mb.Enemy.caps),pb.create(),b(),i(),e()},K.launchGame=function(){n(),window.addEventListener("resize",e,!1),Nb.find("h3 span").text(Mb.Player.name),Ob.find("h3 span").text(Mb.Enemy.name),a("#reset-party-c h4").find("span").text(Mb.Enemy.name),a("#quality").click(function(){a(this).toggleClass("low"),K.quality=a(this).hasClass("low")?"low":"high",e()});for(var b=0;b<pb.capsPerTurn;b++)a(".capsstock").append('<span class="animated zoomIn"></span>');Nb.find(".capsstock span").click(function(){Wb.isPlaying||(a(this).removeClass().addClass("animated zoomOut"),pb.plplay(),Ub.totalLaunched<4&&(Interface.capTuto.hide(),Ub.totalLaunched<3&&Interface.launchTuto.show()))})};var U,V,W={},X=75,Y=u/v,Z=.1,$=1e4;capCollision=function(a,b){var c=this;if(c.collisions++,!c.floating){var d=a.name,e=Math.abs(b.x)+Math.abs(b.y)+Math.abs(b.z);switch(d){case"level":"player"==c.name&&e>60&&Zb.playSd("simpletap3");break;case"tapis":e>60&&Zb.playSd("simpletap1");break;case"floor":e>60&&Zb.playSd("simpletap3");break;case"vlCap":"player"==c.name&&(a.collided=!0,a.__dirty_postion=!0,Zb.playSd("capcap"));break;case"plCap":"viensla"==c.name&&(a.collided=!0,a.__dirty_postion=!0,Zb.playSd("capcap"));break;case"vlBottle":e>60&&Zb.playSd("clink");break;case"plBottle":e>60&&Zb.playSd("clink");break;case"":}}};var _=0,ab=2,bb=ab,cb=6,db=5;s=function(){var a,b,c,d=new THREE.Vector3,e=new THREE.Vector3,f=new THREE.Vector3;return a=function(){M&&(P=!0,_=0,C.fadeIn())},b=function(a){var b=a.clientX,c=a.clientY;M&&Ub.isPlaying&&(TweenMax.set(C,{left:b+50,top:c-50}),Ub.totalLaunched<4&&TweenMax.set(D,{left:b+50,top:c-50})),N.set(b/window.innerWidth*2-1,2*-(c/window.innerHeight)+1.07,1),N.unproject(U),A=N.sub(U.position).normalize(),B=-U.position.z/A.z,realpos=U.position.clone().add(A.multiplyScalar(B/2)),realpos.z=Q*R,M&&(O=realpos)},c=function(){if(M){P=!1,M.__dirtyPosition=!0,M.floating=!1;var a=[3*Math.random()+4,3*Math.random()+4,3*Math.random()+4];e.set(1,1,1),f.set(a[0],a[1],a[2]),M.setAngularFactor(e),M.setLinearFactor(e),d.set(1,1,-_*db*R),M.setLinearVelocity(d),M.setAngularVelocity(f),M.position.copy(O),M=null,K.solo?setTimeout(function(){pb.resetStocks(),pb.vlplay()},3e3):Mb.Player.playerLaunch({x:O.x,y:O.y,z:-O.z,pwr:_,rdms:a}),_=0,Ub.totalLaunched<4&&Interface.launchTuto.hide(),C.fadeOut(),Ub.launched++,Ub.totalLaunched++,Ub.isPlaying=!1,Wb.isPlaying=!0,pb.setTurn(),pb.resetStocks()}},function(){q.domElement.addEventListener("mousedown",a),q.domElement.addEventListener("mousemove",b),q.domElement.addEventListener("mouseup",c)}}();var eb,fb,gb=12424258,hb=11502654,ib=16372607,jb=15971924,kb=16039265,lb=13806677,mb=5854550,nb={chimey:3046655,foster:1454722,lef:16436244,pelle:15876417,chouffe:5086272,ptp:16091953},ob={chimey:3242707,foster:1322598,lef:15582232,pelle:14174280,chouffe:6197575,ptp:15369279},pb={isPlaying:!1,capsPerTurn:1,lives:60,create:function(){Wb.generateCaps(),Wb.score=Ub.score=Wb.launched=Ub.launched=0,Wb.lives=Ub.lives=pb.lives,pb.isPlaying=!0,this.resetStocks(),K.solo?(Wb.isPlaying=!1,Ub.isPlaying=!0):(Wb.isPlaying="Player"==Mb.role,Ub.isPlaying="Host"==Mb.role),Ob.fadeIn(function(){pb.setLife()}),Nb.fadeIn(),Ub.generateCaps(),Interface.txtoRdy||Interface.textoBox.init(),setTimeout(function(){a("#game-loader .tiny-loader").addClass("fade"),setTimeout(function(){a("#game-loader").addClass("fade"),setTimeout(function(){a("#game-loader").remove(),j(G),pb.setTurn(),Zb.fadInSd("ambiance"),Zb.playSd("open")},500)},1e3)},2e3)},resetParty:function(){var b=a("#reset-party-c");Wb.score=Ub.score=Wb.launched=Ub.launched=0,Wb.lives=Ub.lives=pb.lives,Ub.drunked=1,pb.isPlaying=!0,pb.setLife(),K.solo&&(Wb.isPlaying=!1,Ub.isPlaying=!0),pb.setTurn(),TweenMax.to(b,1,{opacity:0,onComplete:function(){TweenMax.set(b,{display:"none"}),j(G),Zb.playSd("open"),TweenMax.set(b.find("h4"),{scale:.5,opacity:0,height:0})}})},setTurn:function(){Ub.isPlaying?(a("#versus-bar #cursor").removeClass().addClass("lf"),TweenMax.to(a("#you-turn"),1.5,{x:40,opacity:1,ease:Elastic.easeOut.config(1,.4),delay:1.8}),TweenMax.to(a("#you-turn"),1,{x:-170,opacity:0,ease:Elastic.easeOut.config(1,.4),delay:4.5}),Ub.totalLaunched<3&&Interface.capTuto.show()):a("#versus-bar #cursor").removeClass().addClass("rg")},vlplay:function(){this.isPlaying&&K.solo&&Wb.launched<pb.capsPerTurn&&!Ub.isPlaying&&(Ob.find(".capsstock span").eq(Wb.launched).removeClass().addClass("animated zoomOut"),Wb.isPlaying=!0,Ub.isPlaying=!1,Wb.launchCaps(),Wb.launched++,Wb.totalLaunched++,Ub.isPlaying=!0,Ub.launched=0,Wb.isPlaying=!1,pb.setTurn(),this.resetStocks())},plplay:function(){this.isPlaying&&Ub.launched<pb.capsPerTurn&&!Wb.isPlaying&&(R=1,h("pl"),Ub.isPlaying=!0,Wb.isPlaying=!1)},vlcaps:function(){if(this.isPlaying){Wb.isPlaying=!1,Ub.isPlaying=!0,Wb.score++,Ub.drunked+=2,Ub.lives-=10;var a=!1;0==Ub.lives&&Wb.lives==pb.lives?(j(J,800),a=!0):this.animCaps(),Wb.launched<pb.capsPerTurn-1&&setTimeout(function(){pb.resetStocks()},2e3),setTimeout(function(){Ub.generateCaps()},2e3),pb.setLife(a)}},plcaps:function(){if(this.isPlaying){Ub.score++,Wb.lives-=10,Ub.isPlaying=!1,Wb.isPlaying=!0,Mb.Player.playerCaps();var a=!1;0==Wb.lives&&Ub.lives==pb.lives?(j(J,800),a=!0):this.animCaps(),setTimeout(function(){Wb.generateCaps()},2e3),pb.setLife(a)}},resetStocks:function(){this.isPlaying&&(a(".capsstock span.zoomOut").removeClass("zoomOut").addClass("zoomIn"),Wb.launched=0,Ub.launched=0),Ub.drunked>11&&(Ub.drunked-=2)},setLife:function(b){"undefined"==typeof b&&(b=!1);var c=b?2600:1600;if(this.isPlaying){var d=Math.round(Ub.lives/pb.lives*100),e=Math.round(Wb.lives/pb.lives*100);Nb.find(".life").height(d+"%"),Ob.find(".life").height(e+"%"),(0>=d||0>=e)&&(a("#share-tw-c iframe").remove(),pb.isPlaying=!1,setTimeout(function(){var b="";0>=d?(j(I,800),Zb.playSd("lose"),setTimeout(Zb.playSd("clairon"),3e3),a("#reset-party-c").removeClass().addClass("looser").find("h3").text("Une petite revanche ?"),K.solo&&(Wb.imprecision+=2),b="Je me suis fait éclater par "+Mb.Enemy.name+" au caps ! J'en veux encore ! À qui le tour ?"):0>=e&&(j(H,800),Zb.playSd("win"),a("#reset-party-c").removeClass().addClass("winner").find("h3").text("On prendra bien la ptite soeur ?"),setTimeout(Zb.playSd("applause"),3e3),Wb.imprecision=Math.max(0,Wb.imprecision-2),b="J'ai éclaté "+Mb.Enemy.name+" au caps ! À qui le tour ?"),E.on("click",function(){FB.ui({method:"feed",name:b,link:"http://www.payetoncaps.com",picture:"http://www.payetoncaps.com/images/logo/fb-logo.png",caption:"Paye ton caps !",description:"Viens faire une petite partie de Caps !"},function(a){a&&a.post_id})}),twttr.widgets.createShareButton("http://www.payetoncaps.com",document.getElementById("share-tw-c"),{text:b,size:"large",count:"none"}),TweenMax.to(a("#reset-party-c"),1,{opacity:1,display:"block",delay:3})},c))}},animCaps:function(){j(F)}},qb=["Sac à bière","Maître Brasseur","Chuck Boris","Vomito","Fredo Mercure","The Undertaker","Capsulator","Golden Capseur","Jean Cirrhose","Jean-Michel Pinte","BURP","Boitsanssoif","Pillier d'comptoir","Bièrelusconi","Edouard Bière","L'incapssable"];Interface={$currentPart:null,curIndex:0,multiRdy:!1,pickNameRdy:!1,pickCapsRdy:!1,gameRdy:!1,txtoRdy:!1,capTuto:null,launchTuto:{},init:function(){Nb=a(".pl-part"),Ob=a(".vl-part"),F=a("#caps-m"),G=a("#start-m"),H=a("#win-m"),I=a("#lose-m"),J=a("#perfect-m"),C=a(".powerbar"),D=a("#launch-tuto"),E=a("#reset-party-c").find("#fb_share"),this.resize(),this.initWelcome(),this.initResetParty(),this.initMenu(),this.hdr.init(),window.addEventListener("resize",Interface.resize,!1),Zb.init(),this.capTuto=Nb.find(".cap-tuto"),this.capTuto.show=function(){TweenMax.fromTo(Interface.capTuto,.5,{scale:0,opacity:0},{scale:1,opacity:1,ease:Elastic.easeOut.config(1,.4),delay:1.8})},this.capTuto.hide=function(){TweenMax.to(Interface.capTuto,.5,{scale:0,opacity:0})},this.launchTuto.show=function(){TweenMax.fromTo(D,.5,{scale:0,opacity:0},{scale:1,opacity:1,ease:Elastic.easeOut.config(1,.4)})},this.launchTuto.hide=function(){TweenMax.to(D,.5,{scale:0,opacity:0})},this.launchTuto.hide()},resize:function(){a("section.sc").css({height:window.innerHeight,lineHeight:window.innerHeight+"px"}),a("#wrapper").css({width:window.innerWidth,height:window.innerHeight}),TweenLite.set(a("#site-content"),{y:-Interface.curIndex*window.innerHeight})},navigate:function(b){3==b?(this.pickNameRdy||this.initPickName(),K.solo||(this.hdr.multiPartyLaunched=!0)):4==b?this.pickCapsRdy||this.initCapsSelect():6==b&&(this.gameRdy||setTimeout(K.launchGame,400)),1==b||3==b||4==b?(this.hdr.show(),this.hdr.multiPartyLaunched&&3==b?this.hdr.hideBt():this.hdr.showBt()):this.hdr.hide(),TweenLite.to(a("#site-content"),.3,{y:-b*window.innerHeight}),this.curIndex=b},navigateBack:function(){var a=0,b=Interface.curIndex;3==b&&K.solo||1==b?a=0:4==b&&(a=3),this.navigate(a)},initWelcome:function(){var b=a("#welcome"),c=b.find(".cp-pelle"),d=b.find(".cp-foster"),e=b.find(".logo"),f=b.find(".water"),g=b.find("#bt-play-solo"),h=b.find("#bt-play-online"),i=a("#bt-back-global");this.$currentPart=b;var j=[new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0})],k=8;j[0].add(TweenMax.fromTo(c,k,{x:-5,y:0,rotation:0,scale:.85},{x:-15,y:-10,rotation:6,scale:1})),j[1].add(TweenMax.fromTo(d,k,{x:0,y:0,rotation:0,scale:.85},{x:8,y:-4,rotation:-6,scale:1})),j[2].add(TweenMax.fromTo(e,k,{x:0,y:0,rotation:0,scale:.9},{x:8,y:3,rotation:4,scale:1})),j[3].add(TweenMax.fromTo(f,k,{x:0,y:0,rotation:0,scale:.8},{x:0,y:0,rotation:-4,scale:1})),setTimeout(function(){j[0].play(),j[1].play(),j[2].play(),j[3].play()},1e3),initializeParty(),g.click(function(){K.solo=!0,a("#wrapper").addClass("solo"),Interface.navigate(3)}),h.click(function(){K.solo=!1,a("#wrapper").removeClass("solo"),Interface.navigate(1),Interface.multiRdy||Interface.initMulti()}),i.click(function(){Interface.navigateBack()})},initMulti:function(b){if(this.multiRdy=!0,b)a("#join-code").val(b),Mb.Player.onPlayerStartClick();else{var c=a("#multiplayer"),d=c.find("#host-party"),e=c.find("#start-party"),f=c.find("#join-party");a("#host-codes .box").click(function(){a(this).find("input").select()}),a("section.wait-section .quit-party").click(function(){Mb.Player.playerQuit(),window.location=location.href.replace(location.hash,"")}),d.on("click",Mb.Host.onCreateClick),f.on("click",Mb.Player.onPlayerStartClick),e.on("click",Mb.Player.onPlayerStartClick)}},initPickName:function(){this.pickNameRdy=!0;var b,c=a("#pickname"),d=c.find("#bt-generate-name"),e=c.find("#bt-send-name"),f=qb.slice();e.on("click",function(){Mb.Player.name=a("#input-player-name").val()||qb[Math.round(Math.random()*(qb.length-1))],Interface.navigate(4)}),d.on("click",function(){clearInterval(b);var c=Math.round(Math.random()*(f.length-1)),d=f.splice(c,1).toString(),e="",g=0,h=a("#input-player-name");b=setInterval(function(){e+=d.charAt(g),h.val(e),g++,g==d.length&&clearInterval(b)},30),0==f.length&&(f=qb.slice())})},initCapsSelect:function(){function b(a){var b=a>i;e.eq(i).addClass(b?"lf":"rg"),e.eq(a).removeClass("lf rg"),e.slice(a+1).addClass("na").removeClass("lf").addClass("rg").removeClass("na"),e.slice(0,a).addClass("na").removeClass("rg").addClass("lf").removeClass("na"),5==a?e.eq(0).addClass("na").removeClass("lf").addClass("rg").removeClass("na"):0==a&&e.eq(5).addClass("na").removeClass("rg").addClass("lf").removeClass("na"),Mb.Player.caps=e.eq(a).attr("id"),c(a),i=a}function c(a){g.removeClass(),g.eq(a).addClass("act"),f.removeClass("act"),f.eq(a).addClass("act"),k.removeClass("ptp chouffe pelle foster lef chimey").addClass(l[a])}this.pickCapsRdy=!0;var d=a("#beer-slide-c"),e=d.find(".cap-list li"),f=a("#beer-bg-slider li"),g=d.find(".nav-bottle li"),h=d.find(".arw"),i=0,j=a("#bt-send-caps"),k=a("#beer-bg-slider .blc-msk"),l=["ptp","chouffe","pelle","foster","lef","chimey"];g.click(function(){var c=a(this).index();b(c)}),h.click(function(){var c=0;c=a(this).hasClass("lf-arw")?0==i?5:i-1:5==i?0:i+1,b(c)}),K.solo?j.on("click",function(){Interface.navigate(6)}):j.on("click",Mb[Mb.role].sendPlayerInfo)},textoBox:{$sdBox:null,$rdBox:null,tm:null,init:function(){if(Interface.txtoRdy=!0,eb=["<p>Maman :</p><p>encore.au.bar?bisou.maman</p>","<p>Chaton <3 :</p><p>"+Mb.Player.name+", c'est fini nous deux, je pars avec Clem.</p>","<p>Soeurette :</p><p>Qu'est-ce que tu fous "+Mb.Player.name+" ?! Tout le monde t'attend au mariage de Tata Jacqueline !</p>","<p>Boss :</p><p>Bonsoir, j'attends votre présentation demain matin à 6h pétante sur mon bureau.</p>","<p>PizzaPingui :</p><p>Dépêchez vous ! Pour deux pizzas Sushiburger achetées, la troisième offerte !</p>","<p>Banque Populass :</p><p>Alerte automatique - Vous avez dépassé les 5000€ de découvert autorisé.</p>","<p>Tony CAZANASS :</p><p>Crois pas que tu vas t'en tirer comme ça "+Mb.Player.name+", on tient ta mère !</p>","<p>Ben :</p><p>Yo gro bien ? dsl mai ta pas 100 balles à m'depanne ?</p>","<p>6917 :</p><p>Envoie VIENSLA au 6917 et rencontre les personnes HOT de ton quartier !</p>"],fb=["<p>Alex:</p><p>Alors tu viens plus aux soirées ?</p>","<p>Alex:</p><p>Apéro ce soir ?</p>","<p>Alex:</p><p>Alors, ça sort ce soir ?</p>","<p>Alex:</p><p>Allooooooooo</p>","<p>Alex:</p><p>???????</p>"],this.$sdBox=a("#sd-messages-box"),this.$rcBox=a("#rc-messages-box"),K.solo){a("#txto-sd").remove();
var b=setInterval(function(){eb.length>0||fb.length>0?Interface.textoBox.showTexto(0):clearInterval(b)},3e4+1e4*Math.random())}var c=this.$rcBox,d=1e4;this.$sdBox.on("click","li",function(){var b=a(this).index();Mb.Player.playerMessage(b),a("#txto-sd").addClass("disabled"),setTimeout(function(){a("#txto-sd").removeClass("disabled")},d)}),this.tm=new TimelineMax({paused:!0}),this.tm.to(c,0,{width:0,height:0,opacity:0}).to(c,.3,{width:250,height:3,opacity:1,ease:Elastic.easeOut.config(1,.4)},.1).to(c,.3,{height:90,ease:Elastic.easeOut.config(1,.4)}),TweenLite.set(c,{width:0,height:0,opacity:0})},showTexto:function(a){var b,c=7500,d=this.$rcBox;if(K.solo)if((Math.random()>.3||0==fb.length)&&eb.length>0){var e=Math.round(Math.random()*(eb.length-1));b=eb[e],eb.splice(e,1)}else fb.length>0&&(b=fb[0],fb.splice(0,1));else b="<p>"+Mb.Enemy.name+" :</p>"+this.$sdBox.find("li div").eq(a).html();d.find(".center").empty().append(b),d.find("p").lettering(),d.find("span").css({opacity:0}),yb&&yb.receiveMessage(),setTimeout(function(){Interface.textoBox.tm.play(),setTimeout(function(){var a=0,b=setInterval(function(){TweenLite.set(d.find("span").eq(a),{opacity:1}),a++,a==d.find("span").length&&clearInterval(b)},.4)},1e3),setTimeout(function(){var a=d.find("span").length-1,b=a,c=setInterval(function(){TweenLite.set(d.find("span").eq(b),{opacity:0}),b--,-1==b&&clearInterval(c)},.2);setTimeout(function(){Interface.textoBox.tm.reverse(),setTimeout(function(){yb.closeMessage()},800)},10*(a-1))},c)},1e3)}},initResetParty:function(){var b=a("#reset-party-c"),c=b.find("h3"),d=b.find("h4");TweenMax.set(d,{scale:.5,opacity:0,height:0}),b.find("#bt-reset-party").click(function(){K.solo?pb.resetParty():(Mb.Player.playerReset(),b.addClass("loading"),TweenMax.to(c,.4,{scale:.5,opacity:0,onComplete:function(){c.text("En attente de ton adversaire..."),TweenMax.to(c,.4,{scale:1,opacity:1,delay:.5,ease:Elastic.easeOut.config(1,.4)})}}))}),b.find("#bt-quit-reset").click(function(){Mb.Player.playerQuit(),window.location=location.href.replace(location.hash,"")})},initMenu:function(){function b(){TweenMax.to(a("footer"),.5,{opacity:0}),TweenMax.to(g,.7,{opacity:0,onComplete:function(){TweenMax.to(c,.3,{opacity:1}),TweenMax.set(g,{display:"none"}),h.addClass("hidden"),TweenMax.set(d,{scale:1,opacity:1}),TweenMax.set(g.find(".pause-logo"),{scale:1,opacity:1}),h.filter("#home-pause").removeClass("hidden"),a("footer").hide()}})}var c=a("#bt-menu"),d=a("#bt-close-menu"),e=a("#bt-close-tuto"),f=a("#lk-quit"),g=a("#pause-menu"),h=g.find(".volet"),i=g.find("#quit-pause"),j=i.find(".bt");c.click(function(){TweenMax.to(g,.7,{opacity:1,display:"block"}),TweenMax.to(c,.3,{opacity:0}),TweenMax.to(a("footer"),.5,{display:"block",opacity:1})}),g.find("#lk-about").click(function(){h.addClass("hidden"),h.filter("#about-pause").removeClass("hidden")}),g.find("#lk-tuto").click(function(){h.addClass("hidden"),h.filter("#tuto-pause").removeClass("hidden"),TweenMax.to(d,.5,{opacity:0}),TweenMax.to(g.find(".pause-logo"),.5,{scale:0,opacity:0,ease:Elastic.easeOut.config(1,.4)}),0==Ub.totalLaunched&&TweenMax.to(Nb.find(".cap-tuto"),.5,{scale:0,opacity:0,ease:Elastic.easeOut.config(1,.4)})}),g.find(".back").click(function(){h.addClass("hidden"),TweenMax.to(g.find(".pause-logo"),.5,{scale:1,opacity:1}),h.filter("#home-pause").removeClass("hidden")}),a(d).click(b),a(e).click(b),f.click(function(){h.addClass("hidden"),i.removeClass("hidden")}),j.click(function(){a(this).hasClass("no")?(h.addClass("hidden"),TweenMax.to(g.find(".pause-logo"),.5,{scale:1,opacity:1}),h.filter("#home-pause").removeClass("hidden")):window.location=location.href.replace(location.hash,"")})},hdr:{$logo:null,$bt:null,active:!0,multiPartyLaunched:!1,init:function(){this.$logo=a("header h1"),this.$bt=a("header .bt"),a("header").hide(),this.hide()},show:function(){a("header").show(),TweenMax.to(Interface.hdr.$logo,.5,{scale:1,opacity:1,ease:Elastic.easeOut.config(1,.4)}),TweenMax.to(a("footer"),.5,{display:"block",opacity:1})},hide:function(){TweenMax.to(a("footer"),.5,{opacity:0}),TweenMax.to(Interface.hdr.$logo,.3,{scale:0,opacity:0,onComplete:function(){a("header").hide(),a("footer").hide()}}),this.hideBt()},hideBt:function(){TweenMax.to(Interface.hdr.$bt,.3,{x:-50,opacity:0,onComplete:function(){Interface.hdr.$bt.hide()}}),this.active=!1},showBt:function(){Interface.hdr.$bt.show(),TweenMax.to(Interface.hdr.$bt,.5,{x:0,opacity:1,ease:Elastic.easeOut.config(1,.4)}),this.active=!1}}},w=170,x=600;var rb,sb,tb,ub,vb,wb,xb,yb,zb,Ab,Bb,Cb,Db,Eb,Fb,Gb,Hb,Ib,Jb,Kb,Lb,Mb,Nb,Ob,Pb=[150,5,30],Qb=[140,55,2],Rb=[],Sb=[],Tb=io.connect();initializeParty=function(){var b={init:function(){b.socket=Tb,b.bindEvents()},bindEvents:function(){b.socket.on("connected",b.onConnection),b.socket.on("newGameCreated",b.onNewGameCreated),b.socket.on("playerJoinedRoom",b.playerJoinedRoom),b.socket.on("createNewPlayer",b.createNewPlayer),b.socket.on("startParty",b.onStartParty),b.socket.on("hostReady",Mb.Player.hostReady),b.socket.on("playerUpdateMove",Mb.Host.playerUpdateMove),b.socket.on("playerUpdateLaunch",Mb.Host.playerUpdateLaunch),b.socket.on("getEnemyInfo",Mb.Host.showEnemy),b.socket.on("enemyChooseBottle",Mb.Host.enemyChooseBottle),b.socket.on("enemyCaps",Mb.Host.enemyCaps),b.socket.on("enemyMessage",Mb.Host.enemyMessage),b.socket.on("playerAskReset",Mb.Host.playerAskReset),b.socket.on("playerAskQuit",Mb.Host.playerAskQuit),b.socket.on("getHostInfo",Mb.Player.getHostInfo),b.socket.on("error",b.error)},onConnection:function(){Mb.socketId=b.socket.socket.sessionid},onNewGameCreated:function(a){Mb.Host.gameInit(a)},playerJoinedRoom:function(a){Mb[Mb.role].updateWaitingScreen(a)},createNewPlayer:function(){},onStartParty:function(a){Mb[Mb.role].showPartyScreen(a)},error:function(a){alert(a.message)}};Mb={gameId:0,role:"",socketId:"",partyOn:!1,nbPlayers:0,hostReady:!1,init:function(){Mb.cacheScreens(),Mb.bindEvents(),Mb.showIntroTpl()},bindEvents:function(){},cacheScreens:function(){Mb.$doc=a(document),Mb.$area=a("#game-area"),Mb.$tplIntroScreen=a("#intro-screen-template").html(),Mb.$tplNewGame=a("#new-game-screen-template").html(),Mb.$tplJoinGame=a("#join-game-template").html(),Mb.$tplGamerScreen=a("#gamer-screen-template").html(),Mb.$tplPartyScreen=a("#party-screen-template").html()},showIntroTpl:function(){},Host:{players:[],numPlayersInRoom:0,resetPlayer:0,onCreateClick:function(){b.socket.emit("hostCreateNewGame")},gameInit:function(a){Mb.gameId=a.gameId,Mb.socketId=a.socketId,Mb.Player.socketId=a.socketId,Mb.role="Host",Mb.Host.numPlayersInRoom=0,Mb.Host.displayNewGameScreen()},displayNewGameScreen:function(){a("#room-code").val(Mb.gameId),a("#room-code-lk").val(window.location.href.replace("www.","")+"#"+Mb.gameId),a(".wait-section .wt-party-code").addClass("act").find("span").text(Mb.gameId),a("#host-part").addClass("rdy"),a("#multiplayer").addClass("hosting")},updateWaitingScreen:function(c){a("#playersWaiting").append("<p>Player "+c.playerName+" joined the game.</p>"),Mb.Host.players.push(c),Mb.Host.numPlayersInRoom+=1,Mb.hostReady=!0,Mb.Host.numPlayersInRoom>1&&(Interface.curIndex<3&&Interface.navigate(3),b.socket.emit("hostRoomReady",{gameId:Mb.gameId,hostReady:Mb.hostReady}))},onStartPartyClick:function(){b.socket.emit("hostStartParty",{gameId:Mb.gameId,socketId:Mb.Player.socketId,hostPlayer:Mb.Host.players})},showPartyScreen:function(){},sendPlayerInfo:function(){Mb.Player.name=a("#input-player-name").val()||"Anonymous";var c={gameId:Mb.gameId,name:Mb.Player.name,caps:Mb.Player.caps,playerID:Mb.socketId};b.socket.emit("hostSendInfo",c),Mb.Player.ready=!0,a(".wait-section .wt-party-code").removeClass("act"),Interface.navigate(Mb.Enemy.ready?6:5)},showEnemy:function(a){"Host"==Mb.role&&Mb.Player.socketId!=a.playerID&&(Mb.Enemy.name=a.name,Mb.Enemy.id=a.playerID)},playerUpdateMove:function(a){a.playerID==Mb.Enemy.id&&(Wb.livePos.x=-a.pos.x,Wb.livePos.y=a.pos.y,Wb.livePos.z=a.pos.z,Wb.liveVector=new THREE.Vector3(Wb.livePos.x,Wb.livePos.y,Wb.livePos.z))},playerUpdateLaunch:function(a){a.playerID==Mb.Enemy.id&&(Wb.livePos.x=-a.shot.x,Wb.livePos.y=a.shot.y,Wb.livePos.z=a.shot.z,Wb.liveVector=new THREE.Vector3(Wb.livePos.x,Wb.livePos.y,Wb.livePos.z),Wb.shootCaps(a.shot))},enemyChooseBottle:function(a){a.playerID==Mb.Enemy.id&&Wb.changeBottle(a.bottle)},enemyCaps:function(a){a.playerID==Mb.Enemy.id&&Ub.drink()},enemyMessage:function(a){a.playerID==Mb.Enemy.id&&Interface.textoBox.showTexto(a.im)},playerAskReset:function(b){Mb.Host.resetPlayer++,Mb.Host.resetPlayer>1?(Mb.Host.resetPlayer=0,pb.resetParty()):b.playerID==Mb.Enemy.id&&TweenMax.to(a("#reset-party-c h4.again"),.4,{scale:1,opacity:1,height:30,lineHeight:"30px"})},playerAskQuit:function(b){b.playerID==Mb.Enemy.id&&(TweenMax.to(a("#reset-party-c h4.quit"),.4,{scale:1,opacity:1,height:30,lineHeight:"30px"}),TweenMax.to(a("#reset-party-c #bt-reset-party"),.4,{scale:0,opacity:0}),TweenMax.to(a("#reset-party-c #bt-quit-reset"),.4,{x:-102}))}},Player:{hostSocketId:"",name:"",socketId:"",caps:"ptp",ready:!1,onJoinClick:function(){Mb.$area.html(Mb.$tplJoinGame)},onPlayerStartClick:function(){var c={gameId:"Host"==Mb.role?Mb.gameId:a("#join-code").val(),playerName:"Host"==Mb.role?"Host":"Player",x:0,y:0};Interface.hdr.hideBt(),K.solo=!1,"Host"==Mb.role?Interface.navigate(1==Mb.Host.numPlayersInRoom?3:2):Mb.role="Player",b.socket.emit("playerJoinGame",c)},updateWaitingScreen:function(c){b.socket.socket.sessionid===c.socketId?(Mb.role="Player",Mb.gameId=c.gameId,Mb.Player.socketId=c.socketId,a("#playerWaitingMessage").text("Joined Game "+c.gameId+". Please wait for game to begin."),Interface.navigate(c.hostReady&&Interface.curIndex<3?3:2)):c.hostReady&&Interface.curIndex<3&&Interface.navigate(3)},hostReady:function(a){b.socket.socket.sessionid!=a.socketId&&Mb.Player.updateWaitingScreen({hostReady:!0,socketId:null})},showPartyScreen:function(){},getHostInfo:function(a){Mb.Player.socketId!=a.playerID&&(Mb.Enemy.name=a.name,Mb.Enemy.id=a.playerID,Mb.Enemy.caps=a.caps,Mb.Enemy.ready=!0,Mb.Player.ready&&Interface.navigate(6))},sendPlayerInfo:function(){var a={gameId:Mb.gameId,name:Mb.Player.name,caps:Mb.Player.caps,playerID:Mb.Player.socketId};b.socket.emit("hostSendInfo",a),Mb.Player.ready=!0,Interface.navigate(Mb.Enemy.ready?6:5)},playerMoving:function(a){b.socket.emit("playerMove",{playerName:Mb.Player.name,playerID:Mb.Player.socketId,gameId:Mb.gameId,pos:a})},playerLaunch:function(a){b.socket.emit("playerShoot",{playerName:Mb.Player.name,playerID:Mb.Player.socketId,gameId:Mb.gameId,shot:a})},playerChooseBottle:function(a){b.socket.emit("playerChooseBottle",{gameId:Mb.gameId,playerID:Mb.Player.socketId,bottle:a})},playerCaps:function(){b.socket.emit("playerCaps",{gameId:Mb.gameId,playerID:Mb.Player.socketId})},playerMessage:function(a){b.socket.emit("playerMessage",{gameId:Mb.gameId,playerID:Mb.Player.socketId,im:a})},playerReset:function(){b.socket.emit("playerReset",{gameId:Mb.gameId,playerID:Mb.Player.socketId})},playerQuit:function(){b.socket.emit("playerQuit",{gameId:Mb.gameId,playerID:Mb.Player.socketId})}},Enemy:{id:null,name:"PayeTaPinte",caps:"ptp",ready:!1}},b.init(),Mb.init()};var Ub={score:0,launched:0,isPlaying:!0,totalLaunched:0,lives:0,drunked:1,capmat:null,stickermat:null,outline:"",pos:{x:0,y:50,z:112},sticker:null,initialize:function(){this.capmat||(this.capmat=Bb.chimey.clone()),this.stickermat||(this.stickermat=new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/chimais.png"),side:2,transparent:!0,opacity:1}));var a=new THREE.MeshBasicMaterial({color:Ub.capmat.materials[1].color,side:2});Kb.buffersNeedUpdate=!0,Kb.uvsNeedUpdate=!0,this.bottle=new Physijs.CylinderMesh(Kb,a,0,{friction:.1,restitution:.1}),this.bottle.scale.set(10,12,10),this.bottle.castShadow=!1,this.bottle.receiveShadow=!0,this.bottle.name="plBottle";var b=new THREE.MeshBasicMaterial({color:Ub.capmat.materials[1].color,transparent:!0,opacity:0}),c=[b,b,b,b,Ub.stickermat,b];this.sticker=new Physijs.BoxMesh(new THREE.BoxGeometry(.8,1,.1),new THREE.MeshFaceMaterial(c),0),this.sticker.position.x=0,this.sticker.position.y=-.3,this.sticker.position.z=.5;var d=new THREE.MeshBasicMaterial({color:ob[Mb.Player.caps],side:2}),e=new Physijs.CylinderMesh(Kb,d,0,{friction:.1,restitution:.1});e.position.x=-.03,e.position.z=.01;var f=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,1,6,6),new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0}),0);f.position.x=0,f.position.y=Qb[1]+Qb[1]/2+45,f.position.z=110,p.add(f),Ub.bottle.add(e),Ub.bottle.add(Ub.sticker),Ub.place({x:0,z:110}),Ub.generateBottle()},changeSticker:function(){var a=new THREE.MeshBasicMaterial({transparent:!0,opacity:0}),b=[a,a,a,a,Ub.stickermat,a];this.sticker.material=new THREE.MeshFaceMaterial(b)},place:function(a){this.bottle.position.y=Qb[1]+Qb[1]/2+23,this.bottle.position.x=a.x,this.bottle.position.z=a.z},generateBottle:function(){p.add(Ub.bottle)},generateCaps:function(){this.bottlecaps=new Physijs.CylinderMesh(Jb,Ub.capmat,.3,{friction:0,restitution:1}),this.bottlecaps.castShadow=!0,this.bottlecaps.receiveShadow=!0,this.bottlecaps.scale.set(S,S,S),this.bottlecaps.rotation.x=Math.PI,this.bottlecaps.position.y=Ub.bottle.position.y+23,this.bottlecaps.position.x=Ub.bottle.position.x,this.bottlecaps.position.z=Ub.bottle.position.z;var a=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:Ub.capmat.materials[1].color,transparent:!0,opacity:1}),0);a.position.x=0,a.position.y=.3,a.position.z=0;var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(3,3,1,32,32),new THREE.MeshLambertMaterial({transparent:!0,opacity:0}),.1);this.bottlecaps.add(b),this.bottlecaps.add(a),this.bottlecaps.name="plCap",this.bottlecaps.collided=!1,p.add(Ub.bottlecaps)},drink:function(){pb.vlcaps()}},Vb=[{y:130,x:-2,pwr:35},{y:110,x:-1,pwr:75},{y:130,x:2,pwr:35},{y:180,x:-2,pwr:21}],Wb={score:0,launched:0,totalLaunched:0,isPerfect:!1,imprecision:16,isPlaying:!1,isShooting:!1,lives:0,capmat:null,livePos:{x:0,y:0,z:-90},liveVector:null,initialize:function(){this.capmat||(this.capmat=Bb.ptp.clone());var a=Physijs.createMaterial(new THREE.MeshBasicMaterial({color:Wb.capmat.materials[1].color,shininess:10,side:2}));this.bottle=new Physijs.CylinderMesh(Kb,a,0,{friction:.1,restitution:.1}),this.bottle.scale.set(10,12,10),this.bottle.castShadow=!1,this.bottle.receiveShadow=!0,this.bottle.name="vlBottle";var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,1,6,6),new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0}),0);b.position.x=0,b.position.y=Qb[1]+Qb[1]/2+45,b.position.z=-110,p.add(b),Wb.place({x:0,z:-110}),Wb.generateBottle()},place:function(a){this.bottle.position.y=Qb[1]+Qb[1]/2+23,this.bottle.position.x=a.x,this.bottle.position.z=a.z},generateBottle:function(){p.add(Wb.bottle)},generateCursor:function(){this.cursor=new THREE.Mesh(new THREE.SphereGeometry(2,32,32),new THREE.MeshBasicMaterial({color:Wb.capmat.materials[1].color,shininess:10,side:2})),this.cursor.position.y=Wb.livePos.y,this.cursor.position.x=Wb.livePos.x,this.cursor.position.z=Wb.livePos.z,p.add(Wb.cursor)},generateCaps:function(){this.bottlecaps=new Physijs.CylinderMesh(Jb,Wb.capmat,.3,{friction:0,restitution:1}),this.bottlecaps.castShadow=!0,this.bottlecaps.receiveShadow=!0,this.bottlecaps.scale.set(S,S,S),this.bottlecaps.rotation.x=Math.PI,this.bottlecaps.position.y=Wb.bottle.position.y+23,this.bottlecaps.position.x=Wb.bottle.position.x,this.bottlecaps.position.z=Wb.bottle.position.z;var a=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,.4,10,10),Physijs.createMaterial(new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0})),0);a.position.x=0,a.position.y=1,a.position.z=0;var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:Wb.capmat.materials[1].color,transparent:!0,opacity:1}),0);b.position.x=0,b.position.y=.3,b.position.z=0;var c=new Physijs.CylinderMesh(new THREE.CylinderGeometry(3,3,1,32,32),new THREE.MeshLambertMaterial({transparent:!0,opacity:0}),.1);this.bottlecaps.add(c),this.bottlecaps.add(b),this.bottlecaps.name="vlCap",this.bottlecaps.collided=!1,p.add(Wb.bottlecaps)},shootCaps:function(a){Wb.isPlaying=!0,Ub.isPlaying=!1;var b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Vector3,e=new THREE.Vector3;R=-1,e.set(Wb.livePos.x,Wb.livePos.y,Wb.livePos.z),h("vl"),M.position.copy(e),M.__dirtyPosition=!0,M.floating=!1,c.set(1,1,1),d.set(-a.rdms[0],a.rdms[1],a.rdms[2]),M.setAngularFactor(c),M.setLinearFactor(c),b.set(1,1,-a.pwr*db*R),M.setLinearVelocity(b),M.setAngularVelocity(d),M=null,Wb.totalLaunched++,setTimeout(function(){Wb.isPlaying=!1,Ub.isPlaying=!0,pb.setTurn()},500)},launchCaps:function(){Wb.isPlaying=!0,Ub.isPlaying=!1;var a=new THREE.Vector3,b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Vector3,e=20*Math.random()+80,f=10*Math.random()-5,g=Math.round(3*Math.random());if(g=Vb[g],R=-1,_=Math.round(g.pwr+(Math.random()-.5)*Wb.imprecision),e=Math.round(g.y+(Math.random()-.5)*Wb.imprecision),f=Math.round(g.x+(Math.random()-.5)*Wb.imprecision),Wb.isPerfect){var i=Math.round(3*Math.random());e=Vb[i].y,f=Vb[i].x,_=Vb[i].pwr}e+=25,d.set(f,e,Q*R+40),h("vl"),M.position.copy(d),M.__dirtyPosition=!0,M.floating=!1,b.set(1,1,1),c.set(10*Math.random(),10*Math.random(),20*Math.random()),M.setAngularFactor(b),M.setLinearFactor(b),a.set(1,-3,-_*cb*R),M.setLinearVelocity(a),M.setAngularVelocity(c),M=null},changeBottle:function(b){Ob.removeClass("chimey foster ptp lef pelle chouffe"),Ob.addClass(b),a("#versus-bar .vl").addClass(b),Wb.capmat=Bb[b],Wb.bottle.material.color=Wb.capmat.materials[1].color}},Xb=".mp3",Yb="assets/sounds/",Zb={ambiance:new Audio(Yb+"ambiance"+Xb),simpletap1:new Audio(Yb+"choc_simple_1"+Xb),simpletap2:new Audio(Yb+"choc_simple_2"+Xb),simpletap3:new Audio(Yb+"choc_simple_3"+Xb),clink:new Audio(Yb+"clink"+Xb),capcap:new Audio(Yb+"caps"+Xb),open:new Audio(Yb+"open"+Xb),pschit2:new Audio(Yb+"pschit_2"+Xb),win:new Audio(Yb+"you-win"+Xb),lose:new Audio(Yb+"you-lose"+Xb),vibreur:new Audio(Yb+"vibreur"+Xb),clairon:new Audio(Yb+"fail"+Xb),applause:new Audio(Yb+"applause"+Xb),perfect:new Audio(Yb+"perfect"+Xb),mute:!1,init:function(){var b=a("#mute");b.on("click",function(){a(this).toggleClass("off"),Zb.mute=!Zb.mute,Zb.ambiance.muted=Zb.mute,Zb.applause.muted=Zb.mute,Zb.clairon.muted=Zb.mute,Zb.vibreur.muted=Zb.mute}),Zb.simpletap1.volume=.4,Zb.perfect.volume=.4,Zb.simpletap2.volume=.4,Zb.simpletap3.volume=.4,Zb.clink.volume=.4,Zb.vibreur.volume=.5,Zb.ambiance.addEventListener("ended",function(){this.currentTime=0,Zb.ambiance.play()},!1),Zb.ambiance.load(),Zb.playSd=function(a){Zb.mute||(Zb[a].currentTime=0,Zb[a].play(),Zb[a].isPlaying=!0)},Zb.fadeSd=function(a,b){var c;"undefined"==typeof b&&(b=0),Zb[a].isFading||(Zb[a].isFading=!0,Zb.mute||(c=setInterval(function(){Zb[a].volume>b+.05?Zb[a].volume-=.05:(Zb[a].volume=b,clearInterval(c),Zb[a].isFading=!1)},200)))},Zb.fadInSd=function(a){var b;Zb[a].isFading||(Zb[a].isFading=!0,Zb[a].volume=0,Zb[a].play(),Zb.mute||(b=setInterval(function(){Zb[a].volume<.3?Zb[a].volume+=.05:(clearInterval(b),Zb[a].isFading=!1)},300)))}}}});