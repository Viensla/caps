...
},l.Vehicle.prototype.addWheel=function(a,b,c,d,e,f,g,h,i){var j=new THREE.Mesh(a,b);j.castShadow=j.receiveShadow=!0,j.position.copy(d).multiplyScalar(f/100).add(c),this.world.add(j),this.wheels.push(j),this.world.execute("addWheel",{id:this._physijs.id,connection_point:{x:c.x,y:c.y,z:c.z},wheel_direction:{x:d.x,y:d.y,z:d.z},wheel_axle:{x:e.x,y:e.y,z:e.z},suspension_rest_length:f,wheel_radius:g,is_front_wheel:h,tuning:i})},l.Vehicle.prototype.setSteering=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("setSteering",{id:this._physijs.id,wheel:b,steering:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("setSteering",{id:this._physijs.id,wheel:c,steering:a})},l.Vehicle.prototype.setBrake=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("setBrake",{id:this._physijs.id,wheel:b,brake:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("setBrake",{id:this._physijs.id,wheel:c,brake:a})},l.Vehicle.prototype.applyEngineForce=function(a,b){if(void 0!==b&&void 0!==this.wheels[b])this.world.execute("applyEngineForce",{id:this._physijs.id,wheel:b,force:a});else if(this.wheels.length>0)for(var c=0;c<this.wheels.length;c++)this.world.execute("applyEngineForce",{id:this._physijs.id,wheel:c,force:a})},l.VehicleTuning=function(a,b,c,d,e,f){this.suspension_stiffness=void 0!==a?a:5.88,this.suspension_compression=void 0!==b?b:.83,this.suspension_damping=void 0!==c?c:.88,this.max_suspension_travel=void 0!==d?d:500,this.friction_slip=void 0!==e?e:10.5,this.max_suspension_force=void 0!==f?f:6e3},l}(),$(function(){function a(){sb.isPlaying&&((Zb.bottlecaps.position.y<=Zb.bottle.position.y||Zb.bottlecaps.position.y>Zb.bottle.position.y+35||Zb.bottlecaps.position.x>Zb.bottle.position.x+7||Zb.bottlecaps.position.x<Zb.bottle.position.x-7||Zb.bottlecaps.position.z>Zb.bottle.position.z+7||Zb.bottlecaps.position.z<Zb.bottle.position.z-7)&&!Zb.bottlecaps.capsed&&(Zb.bottlecaps.capsed=!0,Zb.bottlecaps.collided=!1,sb.plcaps()),(Xb.bottlecaps.position.y<=Xb.bottle.position.y||Xb.bottlecaps.position.y>Xb.bottle.position.y+35||Xb.bottlecaps.position.x>Xb.bottle.position.x+7||Xb.bottlecaps.position.x<Xb.bottle.position.x-7||Xb.bottlecaps.position.z>Xb.bottle.position.z+7||Xb.bottlecaps.position.z<Xb.bottle.position.z-7)&&!Xb.bottlecaps.capsed&&(Xb.bottlecaps.capsed=!0,Xb.bottlecaps.collided=!1,I.solo&&sb.vlcaps())),M&&Xb.isPlaying&&!Zb.isPlaying&&M.position.copy(O),Zb.cursor&&Zb.liveVector&&(Zb.cursor.__dirtyPosition=!1,Zb.cursor.position.copy(Zb.liveVector)),o.simulate(void 0,2),U.lookAt(V);var f=5e-4*Date.now();if(c(f),Math.sin(2*f)>.5&&Cb.animeLight(),Bb)var g=e(Bb,U);TweenLite.set($("#txto-rc"),{y:g.y,x:g.x}),b(f/10),p.render(o,U),x=y.update(),J=x.med/60,Math.abs(J-K)>.1&&(K=J,d()),requestAnimationFrame(a)}function b(a){for(var b=0;b<Ub.length;b++){var c=Ub[b];c instanceof THREE.PointCloud&&(c.rotation.y=a*(4>b?b+1:-(b+1)))}}function c(a){U.initialpos.x+=Math.sin(2*a)*Xb.drunked/70,U.initialpos.y+=Math.cos(2*a)*Xb.drunked/70,U.initialpos.z+=Math.sin(2*a)*Xb.drunked/70,U.position.x+=.3*(20*A.x-U.position.x)*3+U.initialpos.x,U.position.y+=1.5*(10*A.y-U.position.y)+U.initialpos.y+80}function d(){t=window.innerWidth,u=window.innerHeight,T>1?(p.setViewport(0,0,t/2,u/2),p.setSize(t/1.5,u/1.5),$(p.domElement).css({width:t,height:u})):(p.setSize(t,u),p.setViewport(0,0,t,u)),U.aspect=t/u,U.updateProjectionMatrix(),Interface.resize()}function e(a,b){var c=new THREE.Vector3,d=.5*t,e=.5*u;return a.updateMatrixWorld(),c.setFromMatrixPosition(a.matrixWorld),c.project(b),c.x=c.x*d+d,c.y=-(c.y*e)+e,{x:Math.round(c.x),y:Math.round(c.y)}}function f(){W=new THREE.PerspectiveCamera(Y,Z,_,ab),W.initialpos=new THREE.Vector3(0,160,165),W.position.set(W.initialpos.x,W.initialpos.y,W.initialpos.z),W.lookAt(o),o.add(W),X=new THREE.PerspectiveCamera(Y,Z,_,ab),X.initialpos=new THREE.Vector3(0,210,-170),X.position.set(X.initialpos.x,X.initialpos.y,X.initialpos.z),X.lookAt(o),o.add(X),V=new THREE.Vector3(0,50,-100),U=W,A={x:0,y:0},document.addEventListener("mousemove",function(a){A.x=a.clientX/window.innerWidth-.5,A.y=a.clientY/window.innerHeight-.5,U.position.x+=.3*(20*A.x-U.position.x)*3+U.initialpos.x,U.position.y+=1.5*(10*A.y-U.position.y)+U.initialpos.y+80},!1)}function g(a){var b=(Math.random()>.8,2);"undefined"==typeof a&&(a="pl");var c;c="pl"==a?Xb.capmat.clone():Zb.capmat.clone(),c.side=2,q=new Physijs.CylinderMesh(Mb,c,b,{friction:1,restitution:.5}),q.stopGravity=function(){var a,b=this,c=0;setTimeout(function(){b.material.materials[0].transparent=!0,b.material.materials[1].transparent=!0,a=setInterval(function(){b.material.materials[0].opacity=c%2==0?0:1,b.material.materials[1].opacity=c%2==0?0:1,c++,10==c&&(clearInterval(a),b.material.materials[0].opacity=1,b.material.materials[1].opacity=1,o.remove(b))},200-c)},4e3)},q.scale.set(S,S,S),q.collisions=0,q.addEventListener("collision",capCollision);var d=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:q.material.materials[1].color,transparent:!0,opacity:1}),0);d.position.x=0,d.position.y=.3,d.position.z=0,q.add(d);new Physijs.CylinderMesh(new THREE.SphereGeometry(2,32),new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:.6}),0);if(q.position.y=50,q.position.x=0,q.position.z=Q*R,q.castShadow=!0,q.receiveShadow=!0,o.add(q),L.push(q),M=q,M.floating=!0,M.name="vl"==a?"viensla":"player",L.length>4){var e=L[0];e.stopGravity(),L.splice(0,1)}}function h(){var a;a=setInterval(function(){P&&(bb+=db,bb>100&&(db=-cb),0>bb&&(db=+cb),TweenMax.set($(".powerbar .bar"),{height:bb+"%"}))},10+Zb.lives/10)}function i(a,b){"undefined"==typeof b&&(b=300);var c=400;a.attr("class","capsIn1"),setTimeout(function(){a.attr("class","capsIn2"),setTimeout(function(){a.attr("class","capsIn3"),setTimeout(function(){a.attr("class","")},c)},c+b)},c)}function j(){ub=new Physijs.BoxMesh(new THREE.BoxGeometry(1,1,1),new THREE.MeshPhongMaterial({color:ob}),0),ub.position.x=0,ub.position.y=0,ub.position.z=0,ub.castShadow=!1,ub.receiveShadow=!1,ub.name="level",vb=new Physijs.BoxMesh(new THREE.CylinderGeometry(800,800,30,16),new THREE.MeshPhongMaterial({color:lb}),0),vb.position.x=0,vb.position.y=-1,vb.position.z=0,vb.castShadow=!1,vb.receiveShadow=!0,vb.name="floor",ub.add(vb);var a=THREE.Curve.create(function(a){this.scale=void 0===a?1:a},function(a){return new THREE.Vector3(0,a,0).multiplyScalar(this.scale)}),b=new a(200,100),c=new THREE.TubeGeometry(b,100,580,100,!0);Ab=new THREE.Mesh(c,new THREE.MeshBasicMaterial({color:lb,shininess:100,side:THREE.BackSide})),Ab.rotation.y=Math.PI/2,Ab.position.x=0,Ab.position.y=-90,Ab.position.z=100,Ab.castShadow=!0,Ab.receiveShadow=!0,Ab.name="bar",Ab.rotation.x=-.06,ub.add(Ab);var d=THREE.ImageUtils.loadTexture("images/v2/bar_single.png");d.minFilter=THREE.LinearFilter,zb=new Physijs.BoxMesh(new THREE.BoxGeometry(500,125,1),new THREE.MeshBasicMaterial({map:d,transparent:!0,opacity:1}),0),zb.position.x=3,zb.position.y=77,zb.position.z=-435,zb.castShadow=!0,zb.receiveShadow=!0,zb.rotation.x=-.06,ub.add(zb),d=THREE.ImageUtils.loadTexture("images/v2/bar-neon-orange.png"),d.minFilter=THREE.LinearFilter,zb=new Physijs.BoxMesh(new THREE.BoxGeometry(119,68,1),new THREE.MeshPhongMaterial({map:d,transparent:!0,opacity:.7}),0),zb.position.x=3,zb.position.y=180,zb.position.z=-600,zb.castShadow=!0,zb.receiveShadow=!0,ub.add(zb),d=THREE.ImageUtils.loadTexture("images/v2/armoires_back.png"),d.minFilter=THREE.LinearFilter,zb=new Physijs.BoxMesh(new THREE.BoxGeometry(1712,335,10),new THREE.MeshPhongMaterial({map:d,transparent:!0,opacity:.2}),0),zb.rotation.x=-.37,zb.position.x=0,zb.position.y=130,zb.position.z=-600,zb.castShadow=!0,zb.receiveShadow=!0,ub.add(zb),wb=new Physijs.BoxMesh(new THREE.BoxGeometry(v,w,35),new THREE.MeshPhongMaterial({color:jb}),0),wb.rotation.x=Math.PI/2,wb.position.x=0,wb.position.y=0,wb.position.z=0,wb.castShadow=!1,wb.receiveShadow=!1,wb.name="tapis";var e=new Physijs.BoxMesh(new THREE.CylinderGeometry(140,140,10,64),new THREE.MeshPhongMaterial({color:16777215,transparent:!0,opacity:.1}),0);e.rotation.x=Math.PI/2,e.position.y=-80,e.position.z=-10,wb.add(e);var f=new Physijs.BoxMesh(new THREE.CylinderGeometry(90,90,2,64),new THREE.MeshPhongMaterial({color:263172,transparent:!0,opacity:.05}),0);f.scale.set(1,1,.4),f.rotation.x=Math.PI/2,f.position.y=-130,f.position.z=-17,wb.add(f),o.add(wb);var g=new THREE.BoxGeometry(Tb[0],Tb[1]+10,Tb[2]);xb=new Physijs.BoxMesh(g,new THREE.MeshPhongMaterial({color:nb}),0);var h=new Physijs.BoxMesh(g,new THREE.MeshPhongMaterial({color:0}),0);h.position.z=-.5,h.scale.set(1.01,1.05,1.05),xb.castShadow=!0,xb.receiveShadow=!0,xb.rotation.x=.3,xb.position.x=0,xb.position.y=Tb[1]-6.3,xb.position.z=-110,ub.add(xb);var i=new THREE.BoxGeometry(Sb[0],Sb[1],Sb[2]);yb=new Physijs.BoxMesh(i,new THREE.MeshPhongMaterial({color:mb}),0);var j=new Physijs.BoxMesh(i,new THREE.MeshLambertMaterial({color:0}),0);j.position.z=-2,j.position.y=-.5,j.scale.set(1.01,1.05,1.1),yb.position.x=0,yb.position.y=Tb[1]+Tb[1]/2,yb.position.z=-110,yb.castShadow=!0,yb.receiveShadow=!0,ub.add(yb),yb=new Physijs.BoxMesh(new THREE.BoxGeometry(Sb[0]+100,Sb[1],Sb[2]),new THREE.MeshBasicMaterial({color:16171623}),0),j=new Physijs.BoxMesh(new THREE.BoxGeometry(Sb[0]+100,Sb[1],Sb[2]),new THREE.MeshPhongMaterial({color:0}),0),j.position.z=-.5,j.position.y=-.2,j.scale.set(1.01,1,1),yb.position.x=0,yb.position.y=Tb[1]+Tb[1]/2,yb.position.z=110,yb.castShadow=!0,yb.receiveShadow=!0,ub.add(yb),d=THREE.ImageUtils.loadTexture("images/phone/phone_veille.png"),d.minFilter=THREE.LinearFilter;var k=new THREE.MeshPhongMaterial({map:d}),l=new THREE.MeshPhongMaterial({color:16569893}),m=[l,l,k,l,l,l];Bb=new Physijs.BoxMesh(new THREE.BoxGeometry(10,1,14),new THREE.MeshFaceMaterial(m),0),Bb.position.x=50,Bb.position.y=3,Bb.position.z=-5,Bb.rotation.y=.3,Bb.castShadow=!0,Bb.receiveShadow=!0,d=THREE.ImageUtils.loadTexture("images/phone/phone_message.png"),d.minFilter=THREE.LinearFilter;var n=new THREE.Mesh(new THREE.BoxGeometry(10,.1,14),new THREE.MeshBasicMaterial({opacity:0,transparent:!0,map:d}));d=THREE.ImageUtils.loadTexture("images/phone/phone_white.png"),d.minFilter=THREE.LinearFilter;var p=new THREE.Mesh(new THREE.BoxGeometry(10,.1,14),new THREE.MeshBasicMaterial({opacity:0,transparent:!0,map:d}));n.position.set(0,.5,0),p.position.set(0,.5,0),Bb.add(n),Bb.add(p),Bb.receiveMessage=function(){ac.playSd("vibreur");var a=0;n.material.opacity=1,Bb.interval=setInterval(function(){n.material.opacity=a%2==0?0:1,p.material.opacity=a%2==0?1:0,a++,a>5&&clearInterval(Bb.interval)},250)},Bb.closeMessage=function(){clearInterval(Bb.interval),n.material.opacity=0,p.material.opacity=0},yb.add(Bb),o.add(ub);var q=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.02,side:2}),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q);r.scale.set(1,1,1),r.rotation.y=Math.PI/2;var s=new THREE.PointLight(16777215,.1,100);s.position.set(0,150,-80),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.9,.9,.9),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.8,.8,.8),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.7,.7,.7),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.6,.6,.6),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.5,.5,.5),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.4,.4,.4),s.add(r),r=new THREE.Mesh(new THREE.CylinderGeometry(10,164,400,32),q),r.scale.set(.3,.3,.3),s.add(r),o.add(s);var t=new THREE.HemisphereLight(kb,kb,.5);t.color.setHex(kb),t.groundColor.setHSL(.5,.5,.5),t.position.set(0,600,0);var u=document.getElementById("vertexShader").textContent,x=document.getElementById("fragmentShader").textContent,y={topColor:{type:"c",value:new THREE.Color(ib)},bottomColor:{type:"c",value:new THREE.Color(kb)},offset:{type:"f",value:10},exponent:{type:"f",value:.7}};y.topColor.value.copy(t.color);var z=new THREE.SphereGeometry(1600,4,5),A=new THREE.ShaderMaterial({vertexShader:u,fragmentShader:x,uniforms:y,side:THREE.BackSide}),B=new THREE.Mesh(z,A);o.add(B);var C=new THREE.ImageUtils.loadTexture("images/dust.png");C.minFilter=THREE.LinearFilter;for(var D,E=new THREE.Geometry,F=[5,4,3,2,1],G=0;200>G;G++){var H=new THREE.Vector3;H.x=120*Math.random()-60,H.y=120*Math.random()-60,H.z=120*Math.random()-60,E.vertices.push(H)}for(var G=0;G<F.length;G++){var I=new THREE.PointCloudMaterial({size:F[G],map:C,blending:THREE.AdditiveBlending,transparent:!0,opacity:.04});D=new THREE.PointCloud(E,I),D.rotation.x=6*Math.random(),D.rotation.y=6*Math.random(),D.rotation.z=6*Math.random(),D.position.y=120,D.position.z=-50,Ub.push(D),o.add(D)}}function k(){for(var a=[[-40,85,110],[-35,88,110],[-37,89,112],[-34,85,111],[40,85,-110],[35,88,-110],[34,85,-111]],b=0;7>b;b++)Vb.push(new Physijs.CylinderMesh(Mb,Eb.ptp,.4,{friction:1,restitution:.5})),Vb[b].scale.set(S,S,S),Vb[b].position.x=a[b][0],Vb[b].position.y=a[b][1],Vb[b].position.z=a[b][2],Vb[b].rotation.y=Math.PI/(b+1),o.add(Vb[b])}function l(){Db=new THREE.HemisphereLight(16777215,16777215,.3),Db.color.setHSL(.6,1,.6),Db.groundColor.setHSL(.095,1,.75),Db.position.set(0,500,0),o.add(Db);var a=new THREE.DirectionalLight(16777215,.5);a.color.setHSL(.1,1,.95),a.position.set(0,1,0),a.position.multiplyScalar(50),o.add(a),a.castShadow=!0,a.shadowMapWidth=2048,a.shadowMapHeight=2048;var b=50;a.shadowCameraLeft=-b,a.shadowCameraRight=b,a.shadowCameraTop=b,a.shadowCameraBottom=-b,a.shadowCameraFar=3500,a.shadowBias=-1e-4,a.shadowDarkness=.35;var c=new THREE.SpotLight(16777215);c.position.set(0,160,-110),c.target.position.set(0,50,-110),c.target.updateMatrixWorld(),c.intensity=.3,o.add(c);var d=new THREE.SpotLight(16777215);d.position.set(0,300,0),d.target.position.set(0,0,0),d.target.updateMatrixWorld(),d.intensity=.5,o.add(d);var e=new THREE.SpotLight(16777215);e.position.set(0,0,120),e.target.position.set(0,20,-110),e.target.updateMatrixWorld(),e.intensity=1,o.add(e),Cb=new THREE.PointLight(lb,2,100),Cb.position.set(3,180,-580),Cb.animeLight=function(){this.intensity=Math.random()>.9?.2:2},o.add(Cb);var f=c.clone();f.position.set(0,200,120),f.target.position.set(0,50,120),f.target.updateMatrixWorld(),f.intensity=.7,o.add(f);var g=new THREE.SpotLight(16777215);g.position.set(0,300,-20),g.target.position.set(0,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,o.add(g),g=new THREE.SpotLight(16777215),g.position.set(500,300,-20),g.target.position.set(200,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,o.add(g),g=new THREE.SpotLight(16777215),g.position.set(-500,300,-20),g.target.position.set(-200,20,-200),g.target.updateMatrixWorld(),g.intensity=.5,o.add(g);var h=new THREE.HemisphereLight(16777215,16777215,.4);h.color.setHex(15724527),h.groundColor.setHSL(.2,.2,.2),h.position.set(0,300,0),o.add(h);var i=new THREE.HemisphereLight(16777215,16777215,.4);i.color.setHex(15724527),i.position.set(0,300,-400),o.add(i)}function m(){var a=new THREE.JSONLoader;Fb={chimey:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/chimais.png"),side:2,transparent:!0,opacity:1}),foster:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/faustaire.png"),side:2,transparent:!0,opacity:1}),lef:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/lef.png"),side:2,transparent:!0,opacity:1}),pelle:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/pelle.png"),side:2,transparent:!0,opacity:1}),chouffe:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/shouffe.png"),side:2,transparent:!0,opacity:1}),ptp:new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/small/ptp.png"),side:2,transparent:!0,opacity:1})},Fb.chimey.map.minFilter=THREE.LinearFilter,Fb.foster.map.minFilter=THREE.LinearFilter,Fb.lef.map.minFilter=THREE.LinearFilter,Fb.pelle.map.minFilter=THREE.LinearFilter,Fb.chouffe.map.minFilter=THREE.LinearFilter,Fb.ptp.map.minFilter=THREE.LinearFilter,a.load("model/3D/cap_light.json",function(b,c){a.load("model/3D/bottle_light.json",function(a,d){Nb=a;var e=d[0];e.side=2,e.shininess=0,e.shading=0,e.reflectivity=0,e.color.setHex(16777215),Ob=new THREE.MeshFaceMaterial(d),Mb=b;var f=[];f[0]=c[0].clone(),f[1]=c[0].clone(),f[0].side=2,f[1].side=2,f[1].map=0,Hb=new THREE.MeshFaceMaterial(f),Hb.materials[1].color=new THREE.Color(pb.chimey);var g=[];g[0]=c[1].clone(),g[1]=c[0].clone(),g[0].side=2,g[1].side=2,g[1].map=0,Gb=new THREE.MeshFaceMaterial(g),Gb.materials[1].color=new THREE.Color(pb.foster);var h=[];h[0]=c[2].clone(),h[1]=c[0].clone(),h[0].side=2,h[1].side=2,h[1].map=0,Jb=new THREE.MeshFaceMaterial(h),Jb.materials[1].color=new THREE.Color(pb.lef);var i=[];i[0]=c[3].clone(),i[1]=c[0].clone(),i[0].side=2,i[1].side=2,i[1].map=0,Ib=new THREE.MeshFaceMaterial(i),Ib.materials[1].color=new THREE.Color(pb.pelle);var j=[];j[0]=c[4].clone(),j[1]=c[0].clone(),j[0].side=2,j[1].side=2,j[1].map=0,Kb=new THREE.MeshFaceMaterial(j),Kb.materials[1].color=new THREE.Color(pb.chouffe);var k=[];k[0]=c[5].clone(),k[1]=c[2].clone(),k[0].side=2,k[1].side=2,k[1].map=0,Lb=new THREE.MeshFaceMaterial(k),Lb.materials[1].color=new THREE.Color(pb.ptp),Eb={chimey:Hb,foster:Gb,lef:Jb,pelle:Ib,chouffe:Kb,ptp:Lb},s()})})}var n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D,E,F,G,H,I={camera:null,solo:!1,quality:"high"},J=1,K=1,L=[],M=null,N=(new THREE.Vector3,new THREE.Vector3,new THREE.Vector3,new THREE.Vector3),O=(new THREE.Vector3(0,0,0),new THREE.Vector3(0,0,0)),P=(new THREE.Vector3(1,1,1),new THREE.Clock,!1);Physijs.scripts.worker="/js/physics/physics_wkr.js",Physijs.scripts.ammo="ammo.js",t=window.innerWidth,u=window.innerHeight;var Q=100,R=1,S=1.6,T=window.devicePixelRatio||1;s=function(){n=document.getElementById("viewport"),o=new Physijs.Scene,o.setGravity(new THREE.Vector3(0,-80,0)),p=new THREE.WebGLRenderer({antialias:!0,alpha:!0,precision:"lowp",devicePixelRatio:T}),p.setPixelRatio(T),T>1?(p.setViewport(0,0,t/2,u/2),p.setSize(t/1.5,u/1.5),$(p.domElement).css({width:t,height:u})):(p.setSize(t,u),p.setViewport(0,0,t,u)),p.shadowMapEnabled=!1,p.shadowMapSoft=!1,p.shadowMapType=THREE.PCFShadowMap,p.shadowMapAutoUpdate=!1,p.gammaInput=!0,p.gammaOutput=!0,n.appendChild(p.domElement),f(),l(),j(),Zb.initialize(),Xb.initialize(),z=Zb.bottle,o.simulate(),r(),k(),Qb.addClass(Pb.Player.caps),$("#versus-bar .pl").addClass(Pb.Player.caps),Xb.capmat=Eb[Pb.Player.caps].clone(),Xb.stickermat=Fb[Pb.Player.caps].clone(),Xb.bottle.material.color=Xb.capmat.materials[1].color,Xb.changeSticker(),Zb.changeBottle(Pb.Enemy.caps),y=new rb,sb.create(),a(),h()},I.launchGame=function(){m(),window.addEventListener("resize",d,!1),Qb.find("h3 span").text(Pb.Player.name),Rb.find("h3 span").text(Pb.Enemy.name),$("#reset-party-c h4").find("span").text(Pb.Enemy.name),$("#quality").click(function(){$(this).toggleClass("low"),I.quality=$(this).hasClass("low")?"low":"high",d()});for(var a=0;a<sb.capsPerTurn;a++)$(".capsstock").append('<span class="animated zoomIn"></span>');Qb.find(".capsstock span").click(function(){Zb.isPlaying||($(this).removeClass().addClass("animated zoomOut"),sb.plplay(),Xb.totalLaunched<4&&Interface.capTuto.hide())})},$(window).load(function(){});var U,V,W={},X={},Y=75,Z=t/u,_=.1,ab=1e4;capCollision=function(a,b){var c=this;if(c.collisions++,!c.floating){var d=a.name,e=Math.abs(b.x)+Math.abs(b.y)+Math.abs(b.z);switch(d){case"level":"player"==c.name&&e>60&&ac.playSd("simpletap2");break;case"tapis":e>60&&ac.playSd("simpletap1");break;case"floor":e>60&&ac.playSd("simpletap3");break;case"vlCap":"player"==c.name&&(a.collided=!0,a.__dirty_postion=!0,ac.playSd("capcap"));break;case"plCap":"viensla"==c.name&&(a.collided=!0,a.__dirty_postion=!0,ac.playSd("capcap"));break;case"vlBottle":e>60&&ac.playSd("clink");break;case"plBottle":e>60&&ac.playSd("clink");break;case"":}}};var bb=0,cb=2,db=cb,eb=6,fb=5;r=function(){var a,b,c,d=new THREE.Vector3,e=new THREE.Vector3,f=new THREE.Vector3;return a=function(){M&&(P=!0,bb=0,$(".powerbar").fadeIn())},b=function(a){var b=a.clientX,c=a.clientY,d={};$(".powerbar").css({left:b+50,top:c-50}),N.set(b/window.innerWidth*2-1,2*-(c/window.innerHeight)+1.07,1),N.unproject(U),B=N.sub(U.position).normalize(),C=-U.position.z/B.z,d=U.position.clone().add(B.multiplyScalar(C/2)),d.z=Q*R,M&&(O=d)},c=function(){if(M){P=!1,M.__dirtyPosition=!0,M.floating=!1;var a=[3*Math.random()+4,3*Math.random()+4,3*Math.random()+4];e.set(1,1,1),f.set(a[0],a[1],a[2]),M.setAngularFactor(e),M.setLinearFactor(e),d.set(1,1,-bb*fb*R),M.setLinearVelocity(d),M.setAngularVelocity(f),M.position.copy(O),M=null,I.solo?setTimeout(function(){sb.resetStocks(),sb.vlplay()},3e3):Pb.Player.playerLaunch({x:O.x,y:O.y,z:-O.z,pwr:bb,rdms:a}),bb=0,$(".powerbar").fadeOut(),Xb.launched++,Xb.totalLaunched++,Xb.isPlaying=!1,Zb.isPlaying=!0,sb.setTurn(),sb.resetStocks()}},function(){p.domElement.addEventListener("mousedown",a),p.domElement.addEventListener("mousemove",b),p.domElement.addEventListener("mouseup",c)}}();var gb,hb,ib=12424258,jb=11502654,kb=16372607,lb=15971924,mb=16039265,nb=13806677,ob=5854550,pb={chimey:3046655,foster:1454722,lef:16436244,pelle:15876417,chouffe:5086272,ptp:16091953},qb={chimey:3242707,foster:1322598,lef:15582232,pelle:14174280,chouffe:6197575,ptp:15369279},rb=function(){var a=a||!1,b=a&&a.now?a.now.bind(a):Date.now,c=b(),d=c,e=0,f=0,g=0,h=0,i=0;return{begin:function(){c=b()},end:function(){var a=b();return e++,a>d+1e3&&(f=Math.round(1e3*e/(a-d)),d=a,i++,g+=f,h=g/i,e=0),a},update:function(){return c=this.end(),{fps:f,med:h}}}},sb={isPlaying:!1,capsPerTurn:1,lives:60,create:function(){Zb.generateCaps(),Zb.score=Xb.score=Zb.launched=Xb.launched=0,Zb.lives=Xb.lives=sb.lives,sb.isPlaying=!0,this.resetStocks(),I.solo?(Zb.isPlaying=!1,Xb.isPlaying=!0):(Zb.isPlaying="Player"==Pb.role,Xb.isPlaying="Host"==Pb.role),Rb.fadeIn(function(){sb.setLife()}),Qb.fadeIn(),Xb.generateCaps(),Interface.txtoRdy||Interface.textoBox.init(),setTimeout(function(){$("#game-loader .tiny-loader").addClass("fade"),setTimeout(function(){$("#game-loader").addClass("fade"),setTimeout(function(){$("#game-loader").remove(),i(E),sb.setTurn(),ac.fadInSd("ambiance"),ac.playSd("open")},500)},1e3)},2e3)},resetParty:function(){var a=$("#reset-party-c");Zb.score=Xb.score=Zb.launched=Xb.launched=0,Zb.lives=Xb.lives=sb.lives,Xb.drunked=1,sb.isPlaying=!0,sb.setLife(),I.solo&&(Zb.isPlaying=!1,Xb.isPlaying=!0),sb.setTurn(),TweenMax.to(a,1,{opacity:0,onComplete:function(){TweenMax.set(a,{display:"none"}),i(E),ac.playSd("open"),TweenMax.set(a.find("h4"),{scale:.5,opacity:0,height:0})}})},setTurn:function(){Xb.isPlaying?($("#versus-bar #cursor").removeClass().addClass("lf"),TweenMax.to($("#you-turn"),1.5,{x:40,opacity:1,ease:Elastic.easeOut.config(1,.4),delay:1.8}),TweenMax.to($("#you-turn"),1,{x:-170,opacity:0,ease:Elastic.easeOut.config(1,.4),delay:4.5}),Xb.totalLaunched<3&&Interface.capTuto.show()):$("#versus-bar #cursor").removeClass().addClass("rg")},vlplay:function(){this.isPlaying&&I.solo&&Zb.launched<sb.capsPerTurn&&!Xb.isPlaying&&(Rb.find(".capsstock span").eq(Zb.launched).removeClass().addClass("animated zoomOut"),Zb.isPlaying=!0,Xb.isPlaying=!1,Zb.launchCaps(),Zb.launched++,Zb.totalLaunched++,Xb.isPlaying=!0,Xb.launched=0,Zb.isPlaying=!1,sb.setTurn(),this.resetStocks())},plplay:function(){this.isPlaying&&Xb.launched<sb.capsPerTurn&&!Zb.isPlaying&&(R=1,g("pl"),Xb.isPlaying=!0,Zb.isPlaying=!1)},vlcaps:function(){this.isPlaying&&(Zb.isPlaying=!1,Xb.isPlaying=!0,Zb.score++,Xb.drunked+=2,Xb.lives-=10,this.animCaps(),Zb.launched<sb.capsPerTurn-1&&setTimeout(function(){sb.resetStocks()},2e3),setTimeout(function(){Xb.generateCaps()},2e3),sb.setLife())},plcaps:function(){this.isPlaying&&(Xb.score++,Zb.lives-=10,Xb.isPlaying=!1,Zb.isPlaying=!0,Pb.Player.playerCaps(),0==Zb.lives&&Xb.lives==sb.lives?i(H):this.animCaps(),setTimeout(function(){Zb.generateCaps()},2e3),sb.setLife())},resetStocks:function(){this.isPlaying&&($(".capsstock span.zoomOut").removeClass("zoomOut").addClass("zoomIn"),Zb.launched=0,Xb.launched=0),Xb.drunked>11&&(Xb.drunked-=2)},setLife:function(){if(this.isPlaying){var a=Math.round(Xb.lives/sb.lives*100),b=Math.round(Zb.lives/sb.lives*100);Qb.find(".life").height(a+"%"),Rb.find(".life").height(b+"%"),(0>=a||0>=b)&&(sb.isPlaying=!1,setTimeout(function(){0>=a?(i(G,800),ac.playSd("lose"),setTimeout(ac.playSd("clairon"),3e3),$("#reset-party-c").removeClass().addClass("looser").find("h3").text("Une petite revanche ?"),I.solo&&(Zb.imprecision+=2)):0>=b&&(i(F,800),ac.playSd("win"),$("#reset-party-c").removeClass().addClass("winner").find("h3").text("On prendra bien la ptite soeur ?"),setTimeout(ac.playSd("applause"),3e3),Zb.imprecision=Math.max(0,Zb.imprecision-2)),TweenMax.to($("#reset-party-c"),1,{opacity:1,display:"block",delay:3})},1600))}},animCaps:function(){i(D)}},tb=["Sac à bière","Maître Brasseur","Chuck Boris","Vomito","Fredo Mercure","The Undertaker","Capsulator","Golden Capseur","Jean Cirrhose","Jean-Michel Pinte","BURP","Boitsanssoif","Pillier d'comptoir","Bièrelusconi","Edouard Bière","L'incapssable"];Interface={$currentPart:null,curIndex:0,multiRdy:!1,pickNameRdy:!1,pickCapsRdy:!1,gameRdy:!1,txtoRdy:!1,capTuto:null,init:function(){Qb=$(".pl-part"),Rb=$(".vl-part"),D=$("#caps-m"),E=$("#start-m"),F=$("#win-m"),G=$("#lose-m"),H=$("#perfect-m"),this.resize(),this.initWelcome(),this.initResetParty(),this.initMenu(),this.hdr.init(),window.addEventListener("resize",Interface.resize,!1),ac.init(),this.capTuto=Qb.find(".cap-tuto"),this.capTuto.show=function(){TweenMax.fromTo(Interface.capTuto,.5,{scale:0,opacity:0},{scale:1,opacity:1,ease:Elastic.easeOut.config(1,.4),delay:1.8})},this.capTuto.hide=function(){TweenMax.to(Interface.capTuto,.5,{scale:0,opacity:0})}},resize:function(){$("section.sc").css({height:window.innerHeight,lineHeight:window.innerHeight+"px"}),$("#wrapper").css({width:window.innerWidth,height:window.innerHeight}),TweenLite.set($("#site-content"),{y:-Interface.curIndex*window.innerHeight})},navigate:function(a){3==a?(this.pickNameRdy||this.initPickName(),I.solo||(this.hdr.multiPartyLaunched=!0)):4==a?this.pickCapsRdy||this.initCapsSelect():6==a&&(this.gameRdy||setTimeout(I.launchGame,400)),1==a||3==a||4==a?(this.hdr.show(),this.hdr.multiPartyLaunched&&3==a?this.hdr.hideBt():this.hdr.showBt()):this.hdr.hide(),TweenLite.to($("#site-content"),.3,{y:-a*window.innerHeight}),this.curIndex=a},navigateBack:function(){var a=0,b=Interface.curIndex;3==b&&I.solo||1==b?a=0:4==b&&(a=3),this.navigate(a)},initWelcome:function(){var a=$("#welcome"),b=a.find(".cp-pelle"),c=a.find(".cp-foster"),d=a.find(".logo"),e=a.find(".water"),f=a.find("#bt-play-solo"),g=a.find("#bt-play-online"),h=$("#bt-back-global");this.$currentPart=a;var i=[new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0}),new TimelineMax({paused:!0,repeat:-1,yoyo:!0})],j=8;i[0].add(TweenMax.fromTo(b,j,{x:-5,y:0,rotation:0,scale:.85},{x:-15,y:-10,rotation:6,scale:1})),i[1].add(TweenMax.fromTo(c,j,{x:0,y:0,rotation:0,scale:.85},{x:8,y:-4,rotation:-6,scale:1})),i[2].add(TweenMax.fromTo(d,j,{x:0,y:0,rotation:0,scale:.9},{x:8,y:3,rotation:4,scale:1})),i[3].add(TweenMax.fromTo(e,j,{x:0,y:0,rotation:0,scale:.8},{x:0,y:0,rotation:-4,scale:1})),setTimeout(function(){i[0].play(),i[1].play(),i[2].play(),i[3].play()},1e3),initializeParty(),f.click(function(){I.solo=!0,$("#wrapper").addClass("solo"),Interface.navigate(3)}),g.click(function(){I.solo=!1,$("#wrapper").removeClass("solo"),Interface.navigate(1),Interface.multiRdy||Interface.initMulti()}),h.click(function(){Interface.navigateBack()})},initMulti:function(a){if(this.multiRdy=!0,a)$("#join-code").val(a),Pb.Player.onPlayerStartClick();else{var b=$("#multiplayer"),c=b.find("#host-party"),d=b.find("#start-party"),e=b.find("#join-party");$("#host-codes .box").click(function(){$(this).find("input").select()}),c.on("click",Pb.Host.onCreateClick),e.on("click",Pb.Player.onPlayerStartClick),d.on("click",Pb.Player.onPlayerStartClick)}},initPickName:function(){this.pickNameRdy=!0;var a,b=$("#pickname"),c=b.find("#bt-generate-name"),d=b.find("#bt-send-name"),e=tb.slice();d.on("click",function(){Pb.Player.name=$("#input-player-name").val()||tb[Math.round(Math.random()*(tb.length-1))],Interface.navigate(4)}),c.on("click",function(){clearInterval(a);var b=Math.round(Math.random()*(e.length-1)),c=e.splice(b,1).toString(),d="",f=0,g=$("#input-player-name");a=setInterval(function(){d+=c.charAt(f),g.val(d),f++,f==c.length&&clearInterval(a)},30),0==e.length&&(e=tb.slice())})},initCapsSelect:function(){function a(a){var c=a>h;d.eq(h).addClass(c?"lf":"rg"),d.eq(a).removeClass("lf rg"),d.slice(a+1).addClass("na").removeClass("lf").addClass("rg").removeClass("na"),d.slice(0,a).addClass("na").removeClass("rg").addClass("lf").removeClass("na"),5==a?d.eq(0).addClass("na").removeClass("lf").addClass("rg").removeClass("na"):0==a&&d.eq(5).addClass("na").removeClass("rg").addClass("lf").removeClass("na"),Pb.Player.caps=d.eq(a).attr("id"),b(a),h=a}function b(a){f.removeClass(),f.eq(a).addClass("act"),e.removeClass("act"),e.eq(a).addClass("act"),j.removeClass("ptp chouffe pelle foster lef chimey").addClass(k[a])}this.pickCapsRdy=!0;var c=$("#beer-slide-c"),d=c.find(".cap-list li"),e=$("#beer-bg-slider li"),f=c.find(".nav-bottle li"),g=c.find(".arw"),h=0,i=$("#bt-send-caps"),j=$("#beer-bg-slider .blc-msk"),k=["ptp","chouffe","pelle","foster","lef","chimey"];f.click(function(){var b=$(this).index();a(b)}),g.click(function(){var b=0;b=$(this).hasClass("lf-arw")?0==h?5:h-1:5==h?0:h+1,a(b)}),I.solo?i.on("click",function(){Interface.navigate(6)}):i.on("click",Pb[Pb.role].sendPlayerInfo)},textoBox:{$sdBox:null,$rdBox:null,tm:null,init:function(){if(Interface.txtoRdy=!0,gb=["<p>Maman :</p><p>encore.au.bar?bisou.maman</p>","<p>Chaton <3 :</p><p>"+Pb.Player.name+", c'est fini nous deux, je pars avec Clem.</p>","<p>Soeurette :</p><p>Qu'est-ce que tu fous "+Pb.Player.name+" ?! Tout le monde t'attend au mariage de Tata Jacqueline !</p>","<p>Boss :</p><p>Bonsoir, j'attends votre présentation demain matin à 6h pétante sur mon bureau.</p>","<p>PizzaPingui :</p><p>Dépêchez vous ! Pour deux pizzas Sushiburger achetées, la troisième offerte !</p>","<p>Banque Populass :</p><p>Alerte auto - Vous avez dépassé les 5000€ de découvert autorisé.</p>","<p>Tony CAZANASS :</p><p>Crois pas que tu vas t'en tirer comme ça "+Pb.Player.name+", on tient ta mère !</p>","<p>Ben :</p><p>Yo gro bien ? dsl mai ta pas 100 balles à m'depanne ?</p>","<p>6917 :</p><p>Envoie VIENSLA au 6917 et rencontre les personnes HOT de ton quartier !</p>"],hb=["<p>Alex:</p><p>Alors tu viens plus aux soirées ?</p>","<p>Alex:</p><p>Apéro ce soir ?</p>","<p>Alex:</p><p>Alors, ça sort ce soir ?</p>","<p>Alex:</p><p>Allooooooooo</p>","<p>Alex:</p><p>???????</p>"],this.$sdBox=$("#sd-messages-box"),this.$rcBox=$("#rc-messages-box"),I.solo){$("#txto-sd").remove();var a=setInterval(function(){gb.length>0||hb.length>0?Interface.textoBox.showTexto(0):clearInterval(a)},3e4+1e4*Math.random())}var b=this.$rcBox,c=1e4;this.$sdBox.on("click","li",function(){var a=$(this).index();Pb.Player.playerMessage(a),$("#txto-sd").addClass("disabled"),setTimeout(function(){$("#txto-sd").removeClass("disabled")},c)}),this.tm=new TimelineMax({paused:!0}),this.tm.to(b,0,{width:0,height:0,opacity:0}).to(b,.3,{width:250,height:3,opacity:1,ease:Elastic.easeOut.config(1,.4)},.1).to(b,.3,{height:90,ease:Elastic.easeOut.config(1,.4)}),TweenLite.set(b,{width:0,height:0,opacity:0})},showTexto:function(a){var b,c=7500,d=this.$rcBox;if(I.solo)if((Math.random()>.3||0==hb.length)&&gb.length>0){var e=Math.round(Math.random()*(gb.length-1));b=gb[e],gb.splice(e,1)}else hb.length>0&&(b=hb[0],hb.splice(0,1));
else b="<p>"+Pb.Enemy.name+" :</p>"+this.$sdBox.find("li div").eq(a).html();d.find(".center").empty().append(b),d.find("p").lettering(),d.find("span").css({opacity:0}),Bb&&Bb.receiveMessage(),setTimeout(function(){Interface.textoBox.tm.play(),setTimeout(function(){var a=0,b=setInterval(function(){TweenLite.set(d.find("span").eq(a),{opacity:1}),a++,a==d.find("span").length&&clearInterval(b)},.4)},1e3),setTimeout(function(){var a=d.find("span").length-1,b=a,c=setInterval(function(){TweenLite.set(d.find("span").eq(b),{opacity:0}),b--,-1==b&&clearInterval(c)},.2);setTimeout(function(){Interface.textoBox.tm.reverse(),setTimeout(function(){Bb.closeMessage()},800)},10*(a-1))},c)},1e3)}},initResetParty:function(){var a=$("#reset-party-c"),b=a.find("h3"),c=a.find("h4");TweenMax.set(c,{scale:.5,opacity:0,height:0}),a.find("#bt-reset-party").click(function(){I.solo?sb.resetParty():(Pb.Player.playerReset(),a.addClass("loading"),TweenMax.to(b,.4,{scale:.5,opacity:0,onComplete:function(){b.text("En attente de ton adversaire..."),TweenMax.to(b,.4,{scale:1,opacity:1,delay:.5,ease:Elastic.easeOut.config(1,.4)})}}))}),a.find("#bt-quit-reset").click(function(){Pb.Player.playerQuit(),window.location=location.href.replace(location.hash,"")})},initMenu:function(){function a(){TweenMax.to($("footer"),.5,{opacity:0}),TweenMax.to(f,.7,{opacity:0,onComplete:function(){TweenMax.to(b,.3,{opacity:1}),TweenMax.set(f,{display:"none"}),g.addClass("hidden"),TweenMax.set(c,{scale:1,opacity:1}),TweenMax.set(f.find(".pause-logo"),{scale:1,opacity:1}),g.filter("#home-pause").removeClass("hidden"),$("footer").hide()}})}var b=$("#bt-menu"),c=$("#bt-close-menu"),d=$("#bt-close-tuto"),e=$("#lk-quit"),f=$("#pause-menu"),g=f.find(".volet"),h=f.find("#quit-pause"),i=h.find(".bt");b.click(function(){TweenMax.to(f,.7,{opacity:1,display:"block"}),TweenMax.to(b,.3,{opacity:0}),TweenMax.to($("footer"),.5,{display:"block",opacity:1})}),f.find("#lk-about").click(function(){g.addClass("hidden"),g.filter("#about-pause").removeClass("hidden")}),f.find("#lk-tuto").click(function(){g.addClass("hidden"),g.filter("#tuto-pause").removeClass("hidden"),TweenMax.to(c,.5,{opacity:0}),TweenMax.to(f.find(".pause-logo"),.5,{scale:0,opacity:0,ease:Elastic.easeOut.config(1,.4)}),0==Xb.totalLaunched&&TweenMax.to(Qb.find(".cap-tuto"),.5,{scale:0,opacity:0,ease:Elastic.easeOut.config(1,.4)})}),f.find(".back").click(function(){g.addClass("hidden"),TweenMax.to(f.find(".pause-logo"),.5,{scale:1,opacity:1}),g.filter("#home-pause").removeClass("hidden")}),$(c).click(a),$(d).click(a),e.click(function(){g.addClass("hidden"),h.removeClass("hidden")}),i.click(function(){$(this).hasClass("no")?(g.addClass("hidden"),TweenMax.to(f.find(".pause-logo"),.5,{scale:1,opacity:1}),g.filter("#home-pause").removeClass("hidden")):window.location=location.href.replace(location.hash,"")})},hdr:{$logo:null,$bt:null,active:!0,multiPartyLaunched:!1,init:function(){this.$logo=$("header h1"),this.$bt=$("header .bt"),$("header").hide(),this.hide()},show:function(){$("header").show(),TweenMax.to(Interface.hdr.$logo,.5,{scale:1,opacity:1,ease:Elastic.easeOut.config(1,.4)}),TweenMax.to($("footer"),.5,{display:"block",opacity:1})},hide:function(){TweenMax.to($("footer"),.5,{opacity:0}),TweenMax.to(Interface.hdr.$logo,.3,{scale:0,opacity:0,onComplete:function(){$("header").hide(),$("footer").hide()}}),this.hideBt()},hideBt:function(){TweenMax.to(Interface.hdr.$bt,.3,{x:-50,opacity:0,onComplete:function(){Interface.hdr.$bt.hide()}}),this.active=!1},showBt:function(){Interface.hdr.$bt.show(),TweenMax.to(Interface.hdr.$bt,.5,{x:0,opacity:1,ease:Elastic.easeOut.config(1,.4)}),this.active=!1}}},v=170,w=600;var ub,vb,wb,xb,yb,zb,Ab,Bb,Cb,Db,Eb,Fb,Gb,Hb,Ib,Jb,Kb,Lb,Mb,Nb,Ob,Pb,Qb,Rb,Sb=[150,5,30],Tb=[140,55,2],Ub=[],Vb=[],Wb=io.connect();initializeParty=function(){var a={init:function(){a.socket=Wb,a.bindEvents()},bindEvents:function(){a.socket.on("connected",a.onConnection),a.socket.on("newGameCreated",a.onNewGameCreated),a.socket.on("playerJoinedRoom",a.playerJoinedRoom),a.socket.on("createNewPlayer",a.createNewPlayer),a.socket.on("startParty",a.onStartParty),a.socket.on("hostReady",Pb.Player.hostReady),a.socket.on("playerUpdateMove",Pb.Host.playerUpdateMove),a.socket.on("playerUpdateLaunch",Pb.Host.playerUpdateLaunch),a.socket.on("getEnemyInfo",Pb.Host.showEnemy),a.socket.on("enemyChooseBottle",Pb.Host.enemyChooseBottle),a.socket.on("enemyCaps",Pb.Host.enemyCaps),a.socket.on("enemyMessage",Pb.Host.enemyMessage),a.socket.on("playerAskReset",Pb.Host.playerAskReset),a.socket.on("playerAskQuit",Pb.Host.playerAskQuit),a.socket.on("getHostInfo",Pb.Player.getHostInfo),a.socket.on("error",a.error)},onConnection:function(){Pb.socketId=a.socket.socket.sessionid},onNewGameCreated:function(a){Pb.Host.gameInit(a)},playerJoinedRoom:function(a){Pb[Pb.role].updateWaitingScreen(a)},createNewPlayer:function(){},onStartParty:function(a){Pb[Pb.role].showPartyScreen(a)},error:function(a){alert(a.message)}};Pb={gameId:0,role:"",socketId:"",partyOn:!1,nbPlayers:0,hostReady:!1,init:function(){Pb.cacheScreens(),Pb.bindEvents(),Pb.showIntroTpl()},bindEvents:function(){},cacheScreens:function(){Pb.$doc=$(document),Pb.$area=$("#game-area"),Pb.$tplIntroScreen=$("#intro-screen-template").html(),Pb.$tplNewGame=$("#new-game-screen-template").html(),Pb.$tplJoinGame=$("#join-game-template").html(),Pb.$tplGamerScreen=$("#gamer-screen-template").html(),Pb.$tplPartyScreen=$("#party-screen-template").html()},showIntroTpl:function(){},Host:{players:[],numPlayersInRoom:0,resetPlayer:0,onCreateClick:function(){a.socket.emit("hostCreateNewGame")},gameInit:function(a){Pb.gameId=a.gameId,Pb.socketId=a.socketId,Pb.Player.socketId=a.socketId,Pb.role="Host",Pb.Host.numPlayersInRoom=0,Pb.Host.displayNewGameScreen()},displayNewGameScreen:function(){$("#room-code").val(Pb.gameId),$("#room-code-lk").val(window.location.href.replace("www.","")+"#"+Pb.gameId),$(".wait-section .wt-party-code").addClass("act").find("span").text(Pb.gameId),$("#host-part").addClass("rdy"),$("#multiplayer").addClass("hosting")},updateWaitingScreen:function(b){$("#playersWaiting").append("<p>Player "+b.playerName+" joined the game.</p>"),Pb.Host.players.push(b),Pb.Host.numPlayersInRoom+=1,Pb.hostReady=!0,Pb.Host.numPlayersInRoom>1&&(Interface.curIndex<3&&Interface.navigate(3),a.socket.emit("hostRoomReady",{gameId:Pb.gameId,hostReady:Pb.hostReady}))},onStartPartyClick:function(){a.socket.emit("hostStartParty",{gameId:Pb.gameId,socketId:Pb.Player.socketId,hostPlayer:Pb.Host.players})},showPartyScreen:function(){},sendPlayerInfo:function(){Pb.Player.name=$("#input-player-name").val()||"Anonymous";var b={gameId:Pb.gameId,name:Pb.Player.name,caps:Pb.Player.caps,playerID:Pb.socketId};a.socket.emit("hostSendInfo",b),Pb.Player.ready=!0,$(".wait-section .wt-party-code").removeClass("act"),Interface.navigate(Pb.Enemy.ready?6:5)},showEnemy:function(a){"Host"==Pb.role&&Pb.Player.socketId!=a.playerID&&(Pb.Enemy.name=a.name,Pb.Enemy.id=a.playerID)},playerUpdateMove:function(a){a.playerID==Pb.Enemy.id&&(Zb.livePos.x=-a.pos.x,Zb.livePos.y=a.pos.y,Zb.livePos.z=a.pos.z,Zb.liveVector=new THREE.Vector3(Zb.livePos.x,Zb.livePos.y,Zb.livePos.z))},playerUpdateLaunch:function(a){a.playerID==Pb.Enemy.id&&(Zb.livePos.x=-a.shot.x,Zb.livePos.y=a.shot.y,Zb.livePos.z=a.shot.z,Zb.liveVector=new THREE.Vector3(Zb.livePos.x,Zb.livePos.y,Zb.livePos.z),Zb.shootCaps(a.shot))},enemyChooseBottle:function(a){a.playerID==Pb.Enemy.id&&Zb.changeBottle(a.bottle)},enemyCaps:function(a){a.playerID==Pb.Enemy.id&&Xb.drink()},enemyMessage:function(a){a.playerID==Pb.Enemy.id&&Interface.textoBox.showTexto(a.im)},playerAskReset:function(a){Pb.Host.resetPlayer++,Pb.Host.resetPlayer>1?(Pb.Host.resetPlayer=0,sb.resetParty()):a.playerID==Pb.Enemy.id&&TweenMax.to($("#reset-party-c h4.again"),.4,{scale:1,opacity:1,height:30,lineHeight:"30px"})},playerAskQuit:function(a){a.playerID==Pb.Enemy.id&&(TweenMax.to($("#reset-party-c h4.quit"),.4,{scale:1,opacity:1,height:30,lineHeight:"30px"}),TweenMax.to($("#reset-party-c #bt-reset-party"),.4,{scale:0,opacity:0}),TweenMax.to($("#reset-party-c #bt-quit-reset"),.4,{y:-120}))}},Player:{hostSocketId:"",name:"",socketId:"",caps:"ptp",ready:!1,onJoinClick:function(){Pb.$area.html(Pb.$tplJoinGame)},onPlayerStartClick:function(){var b={gameId:"Host"==Pb.role?Pb.gameId:$("#join-code").val(),playerName:"Host"==Pb.role?"Host":"Player",x:0,y:0};Interface.hdr.hideBt(),I.solo=!1,"Host"==Pb.role?Interface.navigate(1==Pb.Host.numPlayersInRoom?3:2):Pb.role="Player",a.socket.emit("playerJoinGame",b)},updateWaitingScreen:function(b){a.socket.socket.sessionid===b.socketId?(Pb.role="Player",Pb.gameId=b.gameId,Pb.Player.socketId=b.socketId,$("#playerWaitingMessage").text("Joined Game "+b.gameId+". Please wait for game to begin."),Interface.navigate(b.hostReady&&Interface.curIndex<3?3:2)):b.hostReady&&Interface.curIndex<3&&Interface.navigate(3)},hostReady:function(b){a.socket.socket.sessionid!=b.socketId&&Pb.Player.updateWaitingScreen({hostReady:!0,socketId:null})},showPartyScreen:function(){},getHostInfo:function(a){Pb.Player.socketId!=a.playerID&&(Pb.Enemy.name=a.name,Pb.Enemy.id=a.playerID,Pb.Enemy.caps=a.caps,Pb.Enemy.ready=!0,Pb.Player.ready&&Interface.navigate(6))},sendPlayerInfo:function(){var b={gameId:Pb.gameId,name:Pb.Player.name,caps:Pb.Player.caps,playerID:Pb.Player.socketId};a.socket.emit("hostSendInfo",b),Pb.Player.ready=!0,Interface.navigate(Pb.Enemy.ready?6:5)},playerMoving:function(b){a.socket.emit("playerMove",{playerName:Pb.Player.name,playerID:Pb.Player.socketId,gameId:Pb.gameId,pos:b})},playerLaunch:function(b){a.socket.emit("playerShoot",{playerName:Pb.Player.name,playerID:Pb.Player.socketId,gameId:Pb.gameId,shot:b})},playerChooseBottle:function(b){a.socket.emit("playerChooseBottle",{gameId:Pb.gameId,playerID:Pb.Player.socketId,bottle:b})},playerCaps:function(){a.socket.emit("playerCaps",{gameId:Pb.gameId,playerID:Pb.Player.socketId})},playerMessage:function(b){a.socket.emit("playerMessage",{gameId:Pb.gameId,playerID:Pb.Player.socketId,im:b})},playerReset:function(){a.socket.emit("playerReset",{gameId:Pb.gameId,playerID:Pb.Player.socketId})},playerQuit:function(){a.socket.emit("playerQuit",{gameId:Pb.gameId,playerID:Pb.Player.socketId})}},Enemy:{id:null,name:"PayeTaPinte",caps:"ptp",ready:!1}},a.init(),Pb.init()};var Xb={score:0,launched:0,isPlaying:!0,totalLaunched:0,lives:0,drunked:1,capmat:null,stickermat:null,outline:"",pos:{x:0,y:50,z:112},sticker:null,initialize:function(){this.capmat||(this.capmat=Eb.chimey.clone()),this.stickermat||(this.stickermat=new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture("images/beers/stickers/chimais.png"),side:2,transparent:!0,opacity:1}));var a=new THREE.MeshBasicMaterial({color:Xb.capmat.materials[1].color,side:2});Nb.buffersNeedUpdate=!0,Nb.uvsNeedUpdate=!0,this.bottle=new Physijs.CylinderMesh(Nb,a,0,{friction:.1,restitution:.1}),this.bottle.scale.set(10,12,10),this.bottle.castShadow=!1,this.bottle.receiveShadow=!0,this.bottle.name="plBottle";var b=new THREE.MeshBasicMaterial({color:Xb.capmat.materials[1].color,transparent:!0,opacity:0}),c=[b,b,b,b,Xb.stickermat,b];this.sticker=new Physijs.BoxMesh(new THREE.BoxGeometry(.8,1,.1),new THREE.MeshFaceMaterial(c),0),this.sticker.position.x=0,this.sticker.position.y=-.3,this.sticker.position.z=.5;var d=new THREE.MeshBasicMaterial({color:qb[Pb.Player.caps],side:2}),e=new Physijs.CylinderMesh(Nb,d,0,{friction:.1,restitution:.1});e.position.x=-.03,e.position.z=.01;var f=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,1,6,6),new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0}),0);f.position.x=0,f.position.y=Tb[1]+Tb[1]/2+45,f.position.z=110,o.add(f),Xb.bottle.add(e),Xb.bottle.add(Xb.sticker),Xb.place({x:0,z:110}),Xb.generateBottle()},changeSticker:function(){var a=new THREE.MeshBasicMaterial({transparent:!0,opacity:0}),b=[a,a,a,a,Xb.stickermat,a];this.sticker.material=new THREE.MeshFaceMaterial(b)},place:function(a){this.bottle.position.y=Tb[1]+Tb[1]/2+23,this.bottle.position.x=a.x,this.bottle.position.z=a.z},generateBottle:function(){o.add(Xb.bottle)},generateCaps:function(){this.bottlecaps=new Physijs.CylinderMesh(Mb,Xb.capmat,.3,{friction:0,restitution:1}),this.bottlecaps.castShadow=!0,this.bottlecaps.receiveShadow=!0,this.bottlecaps.scale.set(S,S,S),this.bottlecaps.rotation.x=Math.PI,this.bottlecaps.position.y=Xb.bottle.position.y+23,this.bottlecaps.position.x=Xb.bottle.position.x,this.bottlecaps.position.z=Xb.bottle.position.z;var a=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:Xb.capmat.materials[1].color,transparent:!0,opacity:1}),0);a.position.x=0,a.position.y=.3,a.position.z=0;var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(3,3,1,32,32),new THREE.MeshLambertMaterial({transparent:!0,opacity:0}),.1);this.bottlecaps.add(b),this.bottlecaps.add(a),this.bottlecaps.name="plCap",this.bottlecaps.collided=!1,o.add(Xb.bottlecaps)},drink:function(){sb.vlcaps()}},Yb=[{y:130,x:-2,pwr:35},{y:110,x:-1,pwr:75},{y:130,x:2,pwr:35},{y:180,x:-2,pwr:21}],Zb={score:0,launched:0,totalLaunched:0,isPerfect:!1,imprecision:16,isPlaying:!1,isShooting:!1,lives:0,capmat:null,livePos:{x:0,y:0,z:-90},liveVector:null,initialize:function(){this.capmat||(this.capmat=Eb.ptp.clone());var a=Physijs.createMaterial(new THREE.MeshBasicMaterial({color:Zb.capmat.materials[1].color,shininess:10,side:2}));this.bottle=new Physijs.CylinderMesh(Nb,a,0,{friction:.1,restitution:.1}),this.bottle.scale.set(10,12,10),this.bottle.castShadow=!1,this.bottle.receiveShadow=!0,this.bottle.name="vlBottle";var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,1,6,6),new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0}),0);b.position.x=0,b.position.y=Tb[1]+Tb[1]/2+45,b.position.z=-110,o.add(b),Zb.place({x:0,z:-110}),Zb.generateBottle()},place:function(a){this.bottle.position.y=Tb[1]+Tb[1]/2+23,this.bottle.position.x=a.x,this.bottle.position.z=a.z},generateBottle:function(){o.add(Zb.bottle)},generateCursor:function(){this.cursor=new THREE.Mesh(new THREE.SphereGeometry(2,32,32),new THREE.MeshBasicMaterial({color:Zb.capmat.materials[1].color,shininess:10,side:2})),this.cursor.position.y=Zb.livePos.y,this.cursor.position.x=Zb.livePos.x,this.cursor.position.z=Zb.livePos.z,o.add(Zb.cursor)},generateCaps:function(){this.bottlecaps=new Physijs.CylinderMesh(Mb,Zb.capmat,.3,{friction:0,restitution:1}),this.bottlecaps.castShadow=!0,this.bottlecaps.receiveShadow=!0,this.bottlecaps.scale.set(S,S,S),this.bottlecaps.rotation.x=Math.PI,this.bottlecaps.position.y=Zb.bottle.position.y+23,this.bottlecaps.position.x=Zb.bottle.position.x,this.bottlecaps.position.z=Zb.bottle.position.z;var a=new Physijs.CylinderMesh(new THREE.CylinderGeometry(2,2,.4,10,10),Physijs.createMaterial(new THREE.MeshLambertMaterial({color:16777215,transparent:!0,opacity:0})),0);a.position.x=0,a.position.y=1,a.position.z=0;var b=new Physijs.CylinderMesh(new THREE.CylinderGeometry(1.5,1.5,0,32,32),new THREE.MeshLambertMaterial({color:Zb.capmat.materials[1].color,transparent:!0,opacity:1}),0);b.position.x=0,b.position.y=.3,b.position.z=0;var c=new Physijs.CylinderMesh(new THREE.CylinderGeometry(3,3,1,32,32),new THREE.MeshLambertMaterial({transparent:!0,opacity:0}),.1);this.bottlecaps.add(c),this.bottlecaps.add(b),this.bottlecaps.name="vlCap",this.bottlecaps.collided=!1,o.add(Zb.bottlecaps)},shootCaps:function(a){Zb.isPlaying=!0,Xb.isPlaying=!1;var b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Vector3,e=new THREE.Vector3;R=-1,e.set(Zb.livePos.x,Zb.livePos.y,Zb.livePos.z),g("vl"),M.position.copy(e),M.__dirtyPosition=!0,M.floating=!1,c.set(1,1,1),d.set(-a.rdms[0],a.rdms[1],a.rdms[2]),M.setAngularFactor(c),M.setLinearFactor(c),b.set(1,1,-a.pwr*fb*R),M.setLinearVelocity(b),M.setAngularVelocity(d),M=null,Zb.totalLaunched++,setTimeout(function(){Zb.isPlaying=!1,Xb.isPlaying=!0,sb.setTurn()},500)},launchCaps:function(){Zb.isPlaying=!0,Xb.isPlaying=!1;var a=new THREE.Vector3,b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Vector3,e=20*Math.random()+80,f=10*Math.random()-5,h=Math.round(3*Math.random());if(h=Yb[h],R=-1,bb=Math.round(h.pwr+(Math.random()-.5)*Zb.imprecision),e=Math.round(h.y+(Math.random()-.5)*Zb.imprecision),f=Math.round(h.x+(Math.random()-.5)*Zb.imprecision),Zb.isPerfect){var i=Math.round(3*Math.random());e=Yb[i].y,f=Yb[i].x,bb=Yb[i].pwr}e+=25,d.set(f,e,Q*R+40),g("vl"),M.position.copy(d),M.__dirtyPosition=!0,M.floating=!1,b.set(1,1,1),c.set(10*Math.random(),10*Math.random(),20*Math.random()),M.setAngularFactor(b),M.setLinearFactor(b),a.set(1,-3,-bb*eb*R),M.setLinearVelocity(a),M.setAngularVelocity(c),M=null},changeBottle:function(a){Rb.removeClass("chimey foster ptp lef pelle chouffe"),Rb.addClass(a),$("#versus-bar .vl").addClass(a),Zb.capmat=Eb[a],Zb.bottle.material.color=Zb.capmat.materials[1].color}},$b=".mp3",_b="assets/sounds/",ac={ambiance:new Audio(_b+"ambiance"+$b),simpletap1:new Audio(_b+"choc_simple_1"+$b),simpletap2:new Audio(_b+"choc_simple_2"+$b),simpletap3:new Audio(_b+"choc_simple_3"+$b),clink:new Audio(_b+"clink"+$b),capcap:new Audio(_b+"caps"+$b),open:new Audio(_b+"open"+$b),pschit2:new Audio(_b+"pschit_2"+$b),win:new Audio(_b+"you-win"+$b),lose:new Audio(_b+"you-lose"+$b),vibreur:new Audio(_b+"vibreur"+$b),clairon:new Audio(_b+"fail"+$b),applause:new Audio(_b+"applause"+$b),mute:!1,init:function(){var a=$("#mute");a.on("click",function(){$(this).toggleClass("off"),ac.mute=!ac.mute,ac.ambiance.muted=ac.mute}),ac.simpletap1.volume=.4,ac.simpletap2.volume=.4,ac.simpletap3.volume=.4,ac.clink.volume=.4,ac.vibreur.volume=.5,ac.ambiance.addEventListener("ended",function(){this.currentTime=0,this.play()},!1),ac.ambiance.load(),ac.playSd=function(a){ac.mute||(ac[a].currentTime=0,ac[a].play(),ac[a].isPlaying=!0)},ac.fadeSd=function(a,b){var c;"undefined"==typeof b&&(b=0),ac[a].isFading||(ac[a].isFading=!0,ac.mute||(c=setInterval(function(){ac[a].volume>b+.05?ac[a].volume-=.05:(ac[a].volume=b,clearInterval(c),ac[a].isFading=!1)},200)))},ac.fadInSd=function(a){var b;ac[a].isFading||(ac[a].isFading=!0,ac[a].volume=0,ac[a].play(),ac.mute||(b=setInterval(function(){ac[a].volume<.3?ac[a].volume+=.05:(clearInterval(b),ac[a].isFading=!1)},300)))}}}});