...
Interface = {
    ...
    init : function(){
        ...
        this.capTuto.show = function(){
            TweenMax.fromTo(Interface.capTuto,0.5,{scale:0, opacity:0}, {scale:1, opacity:1, ease:Elastic.easeOut.config(1, 0.4),  delay:0});
        };
    ...
    textoBox : {
        ...
        init : function(){
            ...
            poteRelou = LANG == 'en' ? [
                "<p>John :</p><p>Dude, where you at? Are you dead, or what?</p>",
                "<p>John :</p><p>Drinks tonight?</p>",
                "<p>John :</p><p>Any cool plans 4 tonight?</p>",
                "<p>John :</p><p>???????</p>",
                "<p>John :</p><p>PICK UP YOUR PHONE!</p>"
            ] : [
