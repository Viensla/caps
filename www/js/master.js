...
//    }
    ...
    if(phone){
        ...
        TweenLite.set(Interface.textoBox.$rcBox,{top:phonePos.y, left:phonePos.x});

//        Interface.textoBox.$rdBox.css({top:phonePos.y, left:phonePos.x});

//        Interface.textoBox.$rdBox[0].style.left = phonePos.x + 'px';
//        Interface.textoBox.$rdBox[0].style.top = phonePos.y + 'px';
    }
...
var Interface = {
    ...
    textoBox : {
        ...
        showTexto : function(i){
            ...
            if(CAPS.solo){
               ...
               texto = this.$sdBox.find('li div').eq(i).html();
            }
    ...
    hdr : {
        ...
        hide : function(){
            TweenMax.to(Interface.hdr.$logo,0.3,{scale:0, opacity:0});
            this.hideBt();
        },
        hideBt : function(){
